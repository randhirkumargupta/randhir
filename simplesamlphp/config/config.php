...
$config = array(
     ...
     * reverse proxy).
     */
    'baseurlpath' => 'https://auth.indiatoday.in/simplesaml/',
    'certdir' => 'cert/',
    'loggingdir' => 'log/',
    'datadir' => 'data/',
     ...
     */
    'secretsalt' => 'sdfhsjk686858jsbdfjkgsdjfgu578sgdfgsk',
    ...
    'memcache_store.servers' => array(
        array(
            array('hostname' => 'itgd-cms-mem-prod-1.yissgx.0001.aps1.cache.amazonaws.com'),
        ),
    ),
