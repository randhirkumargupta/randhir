                  ...
                  <?php if ($view_mode == 'full') { ?>
                    ...
                    if (isset($node->op) && $node->op == 'Preview') {
                      ...
                      foreach ($node->field_mega_review_review['und'] as $mega_item):
                        ...
                        $mega_output.= '<div class="field"><div class="field-label">' . t('Headline:') . '</div><div class="field-items">' . $mega_item['field_buzz_headline']['und'][0]['value'] . '</div></div>';
                        $mega_output.= '<div class="field"><div class="field-label">' . t('Reviewer:') . '</div><div class="field-items">' . $reporter_node->title . '</div></div>';
                        $mega_output.= '<div class="field"><div class="field-label">' . t('Review URL Link:') . '</div><div class="field-items">' . $mega_item['field_mega_review_url_link']['und'][0]['value'] . '</div></div>';
                        $mega_output.= '<div class="field"><div class="field-label">' . t('Description:') . '</div><div class="field-items">' . $mega_item['field_mega_review_description']['und'][0]['value'] . '</div></div>';
                        $mega_output.= '<div class="field"><div class="field-label">' . t('Rating:') . '</div><div class="field-items">' . $mega_item['field_story_rating']['und'][0]['value'] . '</div></div>';
                        $mega_output.= '</div>';
                        $mega_output.= '<hr/><br/>';
                      endforeach;
                      ?>
                    ...
                    <?php
                      ...
                      foreach ($node->field_mega_review_review['und'] as $mega_item):
                        ...
                        $reporter_node = node_load($byline_id);
                        $mega_output.= '<div class="buzz-section">';
                        $mega_output.= '<div class="field"><div class="field-label">' . t('Headline:') . '</div><div class="field-items">' . $ans_detail[$mega_item['value']]->field_buzz_headline['und'][0]['value'] . '</div></div>';
                        $mega_output.= '<div class="field"><div class="field-label">' . t('Reviewer:') . '</div><div class="field-items">' . $reporter_node->title . '</div></div>';
                        $mega_output.= '<div class="field"><div class="field-label">' . t('Review URL Link:') . '</div><div class="field-items">' . $ans_detail[$mega_item['value']]->field_mega_review_url_link['und'][0]['value'] . '</div></div>';
                        $mega_output.= '<div class="field"><div class="field-label">' . t('Description:') . '</div><div class="field-items">' . $ans_detail[$mega_item['value']]->field_mega_review_description['und'][0]['value'] . '</div></div>';
                        $mega_output.= '<div class="field"><div class="field-label">' . t('Rating:') . '</div><div class="field-items">' . $ans_detail[$mega_item['value']]->field_story_rating['und'][0]['value'] . '</div></div>';
                        $mega_output.= '</div>';
                        $mega_output.= '<hr/><br/>';
                      endforeach;
                    }
