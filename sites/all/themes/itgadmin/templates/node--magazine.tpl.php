...
<div class="node node-preview">
  ...
  <div class="field"><div class="field-label">Print Issue Date : </div><div class="field-items"><?php print date('m/d/Y', strtotime($node->field_print_magazine_issue_date[LANGUAGE_NONE][0]['value'])); ?></div></div>
