 ...
 * {@inheritdoc}
 */
function aajtak_preprocess_node(&$variables) {
 ...
 * {@inheritdoc}
 */
function aajtak_preprocess_comment(&$variables) {
 ...
 * {@inheritdoc}
 */
function aajtak_preprocess_field(&$vars) {
 ...
 * {@inheritdoc}
 */
function aajtak_preprocess_page(&$variables) {
  global $base_url;
  $base_root;
  $arg = arg();
 ...
 * {@inheritdoc}
 */
function aajtak_breadcrumb($variables) {
