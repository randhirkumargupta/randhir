...
//alert(settings[iframeId].galleryid);
	...
	function factory(){
		...
		return function iFrameResizeF(options,target){
				write_gallerycode(options.galleryid);
			//alert(options.galleryid);
	...
	//alert(settings.galleryid);
        
    function write_gallerycode(galleryid) {
        var node = document.getElementById('IndiaToday_gallery');
        var type = node.getAttribute('data-type');
        
        if (type == 'QA') {
            var uri = 'http://qa.indiatodayonline.in/';
        } else if (type == 'STAGE') {
            var uri = 'http://staging.indiatodayonline.in/';
        } else if (type == 'UAT') {
            var uri = 'http://uat-it.indiatodayonline.in/';
        } else if (type == 'LOCAL') {
