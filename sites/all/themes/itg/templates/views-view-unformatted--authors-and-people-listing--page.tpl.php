...
.section-authors-list .item-list ul.pager li{width:auto; display:inline; margin:10px 0 15px 0; border:1px solid #ccc; padding:0 3px;}
...
.section-authors-list .item-list ul.pager li.pager-current{width:25px; height:25px; border-radius:50%;background:#337ab7;}
