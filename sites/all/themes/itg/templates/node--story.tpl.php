    ...
    <div class="story-section <?php print $class_buzz; ?>">
        <div class='<?php print $classes ?>'>
            ...
            <div class="story-left-section">
              ...
              <ul>
              <li><a href="javascript:void(0)" class="share"><i class="fa fa-share-alt"></i></a></li>
              <li><a class= "def-cur-pointer" onclick="fbpop(' . "'" . $actual_link . "'" . ', ' . "'" . addslashes(htmlspecialchars($entity[$field_collection_id]->field_buzz_headline[LANGUAGE_NONE][0]['value'], ENT_QUOTES)) . "'" . ', ' . "'" . $share_desc . "'" . ', ' . "'" . $share_image . "'" . ')" class="facebook"><i class="fa fa-facebook"></i></a></li>
