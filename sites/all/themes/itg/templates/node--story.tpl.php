...
if (!empty($content)):
                    ...
                    ?>                      
                            ...
                            <div class="profile-detail">                  
                                ...
                                <ul class="date-update">
                                    ...
                                    ?></li>
                                    <li class="mhide"><span class="share-count"><?php if (!empty($fb_google_count)) {
                                    print $fb_google_count;
                                }
                                else {
                                    print 0;
                                } ?></span>SHARES</li>
    ...
    if (!empty($node->field_story_template_buzz[LANGUAGE_NONE])) {
        ...
        foreach ($node->field_story_template_buzz['und'] as $buzz_item) {
          ...
          </div>' . $img . '</div><span class="image_alt">' . $entity[$field_collection_id]->field_buzz_image['und'][0]['alt'] . '</span>';
                }
