    ...
    ?>
              ...
              <div class="section-left-bototm">
                  <div class="social-list">
                      <ul>
                                      <?php if ($user->uid > 0): ?>
                            <li class="mhide"><a title = "Submit Your Story" class="def-cur-pointer colorbox-load" href="<?php print $base_url; ?>/personalization/my-content/<?php print $node->type; ?>"><i class="fa fa-share"></i><span>Submit Your Story</span></a></li>
                          <?php else: ?>
                            <li class="mhide"><a title = "Submit Your Story" class="def-cur-pointer colorbox-load" href="<?php print $base_url; ?>/node/add/ugc?width=650&height=470&iframe=true&type=<?php print $node->type; ?>"><i class="fa fa-share"></i><span>Submit Your Story</span></a></li>
                          <?php endif; ?>
