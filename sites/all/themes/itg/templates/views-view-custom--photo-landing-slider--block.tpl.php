...
<div class="row">
    <div class="col-md-12">
        ...
        if(in_array('Social Media', $user->roles)) {?>
         <a class="def-cur-pointer colorbox-load" title="promote" href="<?php print $base_url; ?>/itg-social-media-promote/<?php echo $photo_node->nid;?>?width=850&height=850&iframe=true&type=<?php print $video_node->type; ?>"><span>promote</span></a>   
        <?php }?>
