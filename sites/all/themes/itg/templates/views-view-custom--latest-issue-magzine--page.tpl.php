      ...
      foreach ($parent_value as $key => $value) {
        ...
        if ($key == 0) {
          if (!empty($value->uri)) {
            ...
            $img_url = "<img src='" . file_create_url(file_build_uri(drupal_get_path('theme', 'itg') . '/images/itg_image170x127.jpg')) ."' alt='' title='' />";
          }
          if (!empty($lock_story)) {
      ...
      foreach ($suppliment_value as $key => $s_value) {
        ...
        if ($key == 0) {
          if (!empty($s_value->uri)) {
            ...
            $supp_img_url = "<img src='" . file_create_url(file_build_uri(drupal_get_path('theme', 'itg') . '/images/itg_image170x127.jpg')) ."' alt='' title='' />";
          }
          if (!empty($lock_story)) {
