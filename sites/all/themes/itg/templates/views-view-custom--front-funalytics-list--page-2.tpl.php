...
<div class="funalytics-tile">
  <div class="pic"><a class="funalytic-popup" data-nid="<?php echo $row['counter']?>" href="javascript:;"><?php if (empty($file->uri)){?> <img  src="<?php echo  file_create_url(file_build_uri(drupal_get_path('theme', 'itg') . '/images/itg_image370x208.jpg'));?>"> <?php } else{  $img = $file->uri; print theme('image_style', array('path' => $img,'style_name' => 'anchors_landing'));}  ?></a></a></div><div class="funalytics-text">
