...
<ul class="profile-detail">
    <li>Speaker: </li>
    <li class="image"><?php print l($row['field_story_extra_large_image'], $baseurl.'/speaker-details?speaker='.$row['nid'], array('attributes' => array('target'=>'_blank'), 'html' => TRUE)); ?></li>
        <li>
