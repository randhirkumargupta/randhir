...
<div class="social-share"><ul><li><a class="share def-cur-pointer"><i class="fa fa-share-alt"></i></a></li><li><a class= "facebook def-cur-pointer" onclick="fbpop('<?php print $actual_link; ?>', '<?php print $search_share_title; ?>', '<?php print $share_desc; ?>', '<?php print $src; ?>')"><i class="fa fa-facebook"></i></a></li><li><a class= "twitter def-cur-pointer" onclick="twitter_popup('<?php print urlencode($share_title);?>', '<?php print urlencode($short_url); ?>')"><i class="fa fa-twitter"></i></a></li><li><a class= "google def-cur-pointer" onclick="return googleplusbtn('<?php print $actual_link; ?>')"></a></li></ul></div>
