...
if(!empty($position) && $position == 'left') {
  ?>
<div class="n-title search-detail"><h2 title="<?php print $label; ?>"><span class="smily-im"><?php print $smilies; ?></span> <?php print l(mb_strimwidth($label, 0, 65, ".."), $front_url, array("attributes" => array("target" => "_blank", "title" => $label))); ?></h2></div>
<?php } else { ?>
<div class="n-title search-detail"><h2 title="<?php print $label; ?>"><?php print l(mb_strimwidth($label, 0, 65, ".."), $front_url, array("attributes" => array("target" => "_blank", "title" => $label))); ?> <span class="smily-im"><?php print $smilies; ?></span></h2></div>
<?php } ?>