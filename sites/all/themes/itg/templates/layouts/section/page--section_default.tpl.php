...
<?php if (isset($widget_data['itg-block-14']['widget_name']) || isset($widget_data['itg-block-15']['widget_name']) || isset($widget_data['itg-block-16']['widget_name']) || $theme == 'itgadmin') { ?>
    <div class="row itg-common-section">
      ...
      <div class="load-more-wrapper"><a href="javascript:void(0)" class="add-more-block">Add</a></div>
    </div>
<?php } ?>
  <!--End of Common section--> 
...
<?php $divcou = 3 + $divcou; ?>
   <?php if ((EXTRA_SECTION_CARDS != $divcou) && ($divcou != $last_val)) {?>
       <div class="load-more-wrapper"><a href="javascript:void(0)" class="add-more-block">Load More <i class="fa fa-chevron-circle-down" aria-hidden="true"></i></a>
       <?php } if ($theme == 'itgadmin'){?>
