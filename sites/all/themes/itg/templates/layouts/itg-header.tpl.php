            ...
            <li>
               <div class="user-menu">
                 ...
                 if ($_GET['q'] != 'user') {
                   ...
                   if ($user->uid == 0) {
                   ?>
                   <a href="<?php print PARENT_SSO; ?>/saml_login/other/<?php print $uri;?>" class="user-icon sso-click"><i class="fa fa-user"></i> Login</a>
                <?php
                   } else {
                ?>
      ...
      <div class="social-nav mhide">
         <ul class="social-nav mhide">
          ...
          <ul>
                  ...
                  <li><a href="http://itgddev.indiatodayonline.in/rss" title=""><i class="fa fa-rss"></i></a></li>
            ...
            <li class="search-icon-parent">
               <a href="javascript:void(0)" class="search-icon-default" title=""><i class="fa fa-search"></i></a>
               <a href="javascript:void(0)" class="search-icon-search" title="" style="display: none;"><i class="fa fa-search"></i></a>
               <div class="globle-search">
