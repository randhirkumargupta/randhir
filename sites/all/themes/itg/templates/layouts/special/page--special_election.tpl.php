      ...
      <main id="main" class="container pos-rel">
          ...
          <section id="content" role="main">
            ...
            <div class="itg-layout-container election-page <?php echo $itg_class; ?> ">
                ...
                ?>
                <div class="row"><div class="col-md-12 election-top-block"><h1 ' . $display_title . ' id="display_tit"><span class="highlights-title">' . mb_strimwidth($widget_data['itg-block-4']['block_title'], 0, 90, "..") . '</span></h1> <div class="social-share">
                    <ul>
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12 col-sx-12 election-graph left-side">
                        ...
                        <div class="row itg-map">
                            ...
                            <div class="col-md-6 col-sm-6 mt-50">
                                <div class="widget-help-text">Section card ( <strong>Other Stories</strong> )</div>
                                <div class="itg-widget">
                                    <div class="droppable <?php print $gray_bg_layout; ?>">
                    ...
                    <div class="col-md-4 col-sm-12 col-sx-12 right-side">        
                        ...
                        <div class="row">
                            ...
                            <div class="itg-320 col-md-12 col-sm-6 mt-50">
                                <div class="widget-help-text">Special widgets ( <strong>So sorry</strong> )</div>
                                <div class="itg-widget">
                                    <div class="droppable <?php print $gray_bg_layout; ?>">
