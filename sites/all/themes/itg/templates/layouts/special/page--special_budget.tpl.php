          ...
          <section id="content" role="main">
            ...
            <div class="itg-layout-container <?php echo $itg_class; ?> budget-page-layout ">
               ...
               // if (!empty($highlights['node_data']->title)) {
                  echo '<h1><span class="highlights-title">' . mb_strimwidth($widget_data['itg-block-2']['block_title'], 0, 90, "..") . '</span><span class="disc-share"><a href="#"><i class="fa fa-share-alt"></i></a></span></h1>';
                //}
                ?>
