...
<?php if (isset($widget_data['itg-block-12']['widget_name']) || isset($widget_data['itg-block-13']['widget_name']) || $theme == 'itgadmin') { ?>
  ...
  <?php if ($theme == 'itgadmin' && !isset($preview)) { ?>
              ...
              <div class="col-md-4 col-sm-5 col-xs-4 col-lg-4 mt-50" data-tb-region="<?php echo itg_get_dive_region_name($widget_data['itg-block-13']['block_title'], 'Home');?>">
...
?>
          ...
          ?>
          <div><?php if (function_exists('vukkul_view')) {  vukkul_view(); }?></div>
        </div>
      </div>
      <!--------------------------------Code for Front tpl---------------------------------------->
<?php if ($theme != 'itgadmin') { ?>
