...
<style type="text/css"> 
    ...
    #twister iframe#twisstiframe{ position:relative; z-index:-1; }
    #twister .iframe-cover{ width:190px; height: 180px; position: absolute; z-index:1; top:0px; right:0px; background:transparent; }
</style>
<!-- cube scorecard -->
