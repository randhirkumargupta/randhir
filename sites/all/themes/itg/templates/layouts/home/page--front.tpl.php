...
<div id="twister"><span class="crosscloseif" onclick="movebottom()"><span>Open ScoreCard</span> <i class="fa fa-angle-double-down" aria-hidden="true"></i></span><iframe name="crbz_scag_frame" width="180" scrolling="no" height="110" src="https://feeds.intoday.in/xml_it/commentary/cube_ipl99.html" frameborder="0" id="twisstiframe"></iframe><div class="iframe-cover"></div></div>
