...
<style type="text/css">#twister{ position: fixed;right: 0px;bottom: -8px;z-index: 99999; cursor:move; width:190px; height: 180px;}span.crosscloseif{z-index: 99; background: #fff; color: #000;font-size: 20px;font-weight: bold;padding: 5px 10px;position: absolute;top: 16px; right:32px;line-height:20px; box-shadow: 0px -2px 2px 1px #ccc; border-radius: 3px 3px 0 0;}#twister.movearrow{ position: fixed; bottom:-143px; cursor:pointer; }#twister span.crosscloseif span{ display:none; font-size: 12px;line-height: 16px;position: relative;top: -3px;text-transform: uppercase;}#twister.movearrow .fa.fa-angle-double-down:before{content:"\f102"}#twister.movearrow span.crosscloseif{ top:10px; }#twister.movearrow span.crosscloseif span{display: inline-block;; }#twister iframe#twisstiframe{ position:relative; z-index:-1; }#twister .iframe-cover{ width:190px; height: 180px; position: absolute; z-index:1; top:0px; right:0px; background:transparent; }</style>
<!-- cube scorecard -->
