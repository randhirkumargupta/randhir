...
#block-itg-layout-manager-header-block .top-nav .main-nav li:nth-child(3) a:before{width:24px;height:24px;display:inline-block;position:relative;top:0px;left:0px;background:url(https://smedia2.intoday.in/indiatoday/livedot.gif) no-repeat 0 0;}
