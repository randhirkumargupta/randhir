...
?>
<?php if ((isset($isCookies) && $isCookies == 'yes' && user_is_anonymous()) || (user_is_logged_in() && $poll_uid == $user->uid)) { ?>
  <?php
...
// 2 = After Poll Completion.
  if (($display_format == 1) || ($display_format == 2 && $endtime < time())) { // && $endtime > time()
    ?>
