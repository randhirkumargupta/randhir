...
<div class="cm-node-view">
  ...
  <div class="field-div"><div class="field-label">Status: </div><div class="field-item"><?php print $node->field_magazine_publish[LANGUAGE_NONE][0]['value'] ? 'Published' : 'Unpublished'; ?></div></div>
</div>
