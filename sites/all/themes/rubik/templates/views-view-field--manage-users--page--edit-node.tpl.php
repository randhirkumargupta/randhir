...
if (array_key_exists(EDITOR, $user->roles)) {
    ...
    $user_array = array(AUTHOR_GUEST=>'Author/Guest', COPY_EDITOR=>'Copy Editor', EDITOR=>'Editor', EXPERT=>'Expert', INTERN=>'Intern', SECTION_EDITOR_ANCHOR=>'Section Editor/Anchor',  SUBEDITOR_SR_SUB=>'Subeditor/Sr.Sub' );
  }
