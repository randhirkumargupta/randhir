...
.sidebar-second.page-authors-list.section-authors-list ul.pagination li{width:auto; display:inline; margin:10px 0 15px 0; padding:0 3px; float:none}
.sidebar-second.page-authors-list.section-authors-list ul.pagination li a{display: inline-block;font-size: 1rem;text-align: center;line-height: 16px; background:none; border:0; width:30px; height:30px;}
.sidebar-second.page-authors-list.section-authors-list ul.pagination li a:hover,.sidebar-second.page-authors-list.section-authors-list ul.pagination li a.current{background:#337ab7; border-radius:50%; color:#fff;}
