      ...
      <div class="row">
          ...
          <div class="big-story-col-2">
              <?php if (!empty($data['node_data']->title)) : ?>
                ...
                ?>
                <h1 <?php echo $data_tb_region_item;?> title="<?php echo strip_tags($node_title); ?>" class="big-story-first big-story-<?php print $data['node_data']->nid . ' ' . $red_dot_class ?> <?php print $pipelineclass; ?>">
