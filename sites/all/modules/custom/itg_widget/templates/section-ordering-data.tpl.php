...
if ($widget_style == 'auto-road-trip') {
            ...
            foreach ($data as $count => $entity) {
              ...
              <li class="trending-videos-list">
                  ...
                  <?php if (!empty($extra_large_image_url)) { ?>
                    ...
                    ?>
                    <a class="pic <?php echo $video_class; ?>" href="<?php echo $base_url . '/' . drupal_get_path_alias("node/$nid"); ?>">
                        <img  height="66" width="88" src="<?php print image_style_url("widget_very_small", drupal_get_path('theme', 'itg') . '/images/itg_image88x66.jpg');?>" alt="" />
                    </a>
                  <?php }
                  ?>
          ...
          if (!empty($data)) {
            foreach ($data as $count => $entity) {
              ...
              if ((!empty($entity['mi_file_uri']) && isset($entity['mi_file_uri']))) {
                ...
                $extra_large_image_url =  image_style_url("anchors_landing", drupal_get_path('theme', 'itg') . '/images/itg_image370x208.jpg');
              }
            ...
            foreach ($data as $count => $entity) {
              ...
              if ($count == 0) {
                ...
                if ((!empty($entity['esi_file_uri']) && isset($entity['esi_file_uri']))) {
                  ...
                  $extra_large_image_url = image_style_url("widget_very_small", drupal_get_path('theme', 'itg') . '/images/itg_image88x66.jpg');
                }
                ?>
                <ul>
                    <li>
            ...
            foreach ($data as $count => $entity) {
              ...
              if ($count == 0) {
                ...
                if ((!empty($entity['si_file_uri']) && isset($entity['si_file_uri']))) {
                  ...
                  $extra_large_image_url =  image_style_url("widget_small", drupal_get_path('theme', 'itg') . '/images/itg_image170x127.jpg');
                }
                ?>
  ...
  foreach ($data as $count => $entity) {
    ...
    if ((!empty($entity['uri']) && isset($entity['uri']))) {
      ...
      $extra_large_image_url =  image_style_url("section_ordering_widget", drupal_get_path('theme', 'itg') . '/images/itg_image370x208.jpg');
    }
    ?>
            ...
            foreach ($data as $count => $entity) {
              ...
              <li class="trending-videos-list">
                ...
                <span class="pic  <?php echo $video_class; ?>"> <a href="<?php echo $base_url . '/' . drupal_get_path_alias("node/$nid"); ?>"> <img  src="<?php print $extra_large_image_url ?>" alt="" title="" /> </a></span>
                    ...
                    ?>
                <span class="pic <?php echo $video_class; ?>"> <a href="<?php echo $base_url . '/' . drupal_get_path_alias("node/$entity->nid"); ?>">   <img width="88" height="66" src="<?php print image_style_url("widget_very_small", drupal_get_path('theme', 'itg') . '/images/itg_image88x66.jpg');?>" alt="" title="" /></a></span>
            ...
            <?php if ($count == 0) : ?>
              <div class="magazine-detail">
                  ...
                  <?php if (!empty($extra_large_image_url)) { ?>
                    ...
                    ?>
                    <a class="<?php echo $video_class; ?>" href="<?php echo $base_url . '/' . drupal_get_path_alias("node/$nid"); ?>">
                      <img class="defalt-placeholder-magazin"  height="140" width="100" src="<?php print  image_style_url("anchors_landing", drupal_get_path('theme', 'itg') . '/images/itg_image370x208.jpg');?>" alt="" title="" />
                    </a>
                  <?php } ?>
          ...
          foreach ($data as $count => $entity) {
            ...
            <?php if ($count == 0) : ?>
              <?php if (!empty($extra_large_image_url)) { ?>
                ...
                ?>
                <a class="<?php echo $video_class; ?>" href="<?php echo $base_url . '/' . drupal_get_path_alias("node/$nid"); ?>">
                  <img  height="208" width="370" src="<?php print  image_style_url("anchors_landing", drupal_get_path('theme', 'itg') . '/images/itg_image370x208.jpg');?>" alt="" title="" />
                </a>
              <?php } ?>
              <h3 title="<?php echo $entity['title']; ?>" class="frist-heading heading-<?php echo $nid ?> <?php echo $entity['type'] ?> ">
                  <?php
