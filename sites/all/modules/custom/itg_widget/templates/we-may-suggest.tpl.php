    ...
    <div class="may-be-suggest-container">
        ...
        <?php foreach ($entity_data as $key => $entity_info) { ?>
            <li class="may-be-suggest" id="may-be-suggest-<?php print $key ?>">
                ...
                <a href="#" class="pic" title="<?php (!empty($entity_info->field_story_extra_large_image['und'][0]['title'])) ? print $entity_info->field_story_extra_large_image['und'][0]['title']  : print $entity_info->field_story_extra_large_image['und'][0]['filename']  ?>">
