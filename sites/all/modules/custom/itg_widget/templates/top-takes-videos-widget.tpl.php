<?php if (!empty($data)) : global $base_url; ?>
    <div class="top-takes-video-container">
        ...
        if (empty($is_fron_page)) { ?><h3><span><?php print t("Top Takes") ?></span></h3><?php } ?>
        <ul>  
        ...
        <?php if (!empty($video_data->field_story_extra_small_image['und'][0]['uri'])) { ?>
            ...
            <?php $file_uri = file_create_url($video_data->field_story_extra_small_image['und'][0]['uri']); ?>
