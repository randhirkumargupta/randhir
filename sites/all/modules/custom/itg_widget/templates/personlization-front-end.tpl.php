      ...
      <li class="recom-listing">
        ...
        <div class="detail">
          ...
          <a href="<?php echo $base_url . '/' . drupal_get_path_alias("node/{$node_info['node_data']['nid']}"); ?>">
            <?php
            if ($frist_key == 0) {
              echo l(mb_strimwidth($node_info['node_data']['title'], 0, 240, ".."));
            }
            else {
              echo l(mb_strimwidth($node_info['node_data']['title'], 0, 80, ".."));
            }
            ?>
          </a>
        </div>
      ...
      foreach ($info as $node_info) {
        ...
        <li class="recom-listing">
          ...
          <div class="detail">
            <h4><?php print $node_info['taxonomy_name']; ?></h4>
            <a href="<?php echo $base_url . '/' . drupal_get_path_alias("node/{$node_info['node_data']['nid']}"); ?>">
              <?php echo l(mb_strimwidth($node_info['node_data']['title'], 0, 80, "..")); ?>
            </a>
          </div>
