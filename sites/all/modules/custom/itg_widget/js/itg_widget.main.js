...
Drupal.behaviors.itg_widget = {
    attach: function (context, settings) {
        ...
        if (settings.itg_widget.data) {
            ...
            jQuery('<p>Are you sure you want add this content</p>').insertAfter(jQuery('#views-form-photo-carousel-widget-photo-carousel-list , #views-form-story-widget-page-1, #views-form-home-page-feature-widget-page-1, #views-form-story-widget-trending-videos, #views-form-story-widget-most-popular, #views-form-photo-carousel-widget-video-carousel-list').find('.form-item-qids'));
            jQuery('#views-form-photo-carousel-widget-photo-carousel-list,#views-form-story-widget-page-1, #views-form-home-page-feature-widget-page-1,  #views-form-story-widget-trending-videos, #views-form-story-widget-most-popular, #views-form-photo-carousel-widget-video-carousel-list').find('#edit-submit').val('Confirm');
            jQuery('#views-form-photo-carousel-widget-photo-carousel-list, #views-form-story-widget-page-1, #views-form-home-page-feature-widget-page-1, #views-form-story-widget-trending-videos, #views-form-story-widget-most-popular, #views-form-photo-carousel-widget-video-carousel-list').find('.form-item-qids').hide();
