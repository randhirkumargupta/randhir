...
video_field_update_sub_category_map();

function video_field_update_sub_category_map() {
  $path_xml = 'sites/default/files/migrate/xml_file/videos_cateogory_complete_2015-16/';
...
//$node_new_sefurl = itg_migrate_new_custompath($node, $published_dates, $node_sef);
    ...
    if (copy($path_xml . $file_name, "sites/default/files/migrate/xml_file/videos_sub_cateogory_complete_2015-16/" . $file_name)) {
