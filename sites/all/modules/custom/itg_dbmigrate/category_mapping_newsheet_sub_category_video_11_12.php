...
function video_field_update_sub_category_map_11() {
  $path_xml = 'sites/default/files/migrate/xml_file/videos_category_complete_2011-12/';
...
//$node_new_sefurl = itg_migrate_new_custompath($node, $published_dates, $node_sef);
    ...
    if (copy($path_xml . $file_name, "sites/default/files/migrate/xml_file/videos_sub_cateogory_complete_2011-12/" . $file_name)) {
...
function category_mapping_script() {
  $file_path = 'sites/default/files/migrate/xml_file/new_cat_map_video_11_12/';
