...
function video_field_update_cat_map() {
  $path_xml = 'sites/default/files/migrate/xml_file/videos-2017/';
...
function category_mapping_script_video() {
  //$file_path = 'sites/default/files/cat_mapping/';
   $file_path = 'sites/default/files/cat_mapping/';
  $file_name = 'Section_Category_Mapping-Jan1-Jun292017.csv';
...
function check_updated_node_photo($nid, $xml_id, $xml_file_name) {
  ...
  $query->condition('image_update', 'video_2017', '=');
  $result = $query->execute()->fetchField();
