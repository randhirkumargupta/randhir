...
<style type="text/css">
    ...
    .tv-schedule-news.tez_tvschedule-csv:before{background: url('<?php print $base_url; ?>/sites/all/themes/itg/images/tezlogo.png') 0 0 / 100% auto no-repeat;}
    .tv-schedule-news.Dilliaajtak_tvschedule-csv:before{background: url('<?php print $base_url; ?>/sites/all/themes/itg/images/delhiaajtaklogo.png') 0 0 / 100% auto no-repeat;}
    .tv-schedule-news.aajtak_tvschedule-csv:before{background: url('<?php print $base_url; ?>/sites/all/themes/itg/images/aajtaklogo.png') 0 0 / 100% auto no-repeat;}
    .tv-schedule-news.Indiatoday_tvschedule-csv:before{background: url('<?php print $base_url; ?>/sites/all/themes/itg/images/indiatodaylogo.png') 0 0 / 100% auto no-repeat;}
