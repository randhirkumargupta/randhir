...
<!--  <span class="target-link" data-target-id="tab-quiz-section"><?php //print t('Categorization'); ?></span>  -->
  ...
  <span class="target-link" data-target-id="tab-quiz-publish-unpublish"><?php print t('Publish/Unpublish'); ?></span>
  <span class="target-link" data-target-id="tab-quiz-metatags"><?php print t('SEO Meta Details'); ?></span>  
</div>
