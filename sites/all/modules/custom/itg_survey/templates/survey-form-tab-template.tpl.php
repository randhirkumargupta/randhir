...
<div class="block-itg-story-list">
  ...
  <span class="target-link" data-target-id="BrowseMedia"><?php print t('Date Settings'); ?></span>
  <span class="target-link" data-target-id="Templates"><?php print t('Survey Question'); ?></span>
