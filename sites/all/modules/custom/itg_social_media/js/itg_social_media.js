...
jQuery(document).ready(function() {
  ...
  jQuery('.require-one-edit-itg-smi').on('click', function() {
    var i = 0;
    jQuery('.require-one-edit-itg-smi').each(function() {
    ...
    if (i == 0) {
      ...
      jQuery('#edit-itg-smi-facebook').attr('checked', true);
      jQuery('#edit-fb-wrap').show();
