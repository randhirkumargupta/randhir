          ...
          <div class="col-md-8 col-sm-8" style="color:<?php print $menu_font_color; ?>">
              ...
              <ul class="menu">
                  ...
                  if ($event_config_home) {
                    print '<li>' . l(t('Home'), $baseurl, array('attributes' => array("style" => "color:$home_menu"))) . '</li>';
                  }

                  if ($event_config_programme) {
                    print '<li>' . l(t('Programme'), $baseurl . '/programme', array('attributes' => array("style" => "color:$program_menu"))) . '</li>';
                  }
                  ...
                  if ($event_config_sponsors) {
                    print '<li>' . l(t('Sponsors'), $baseurl . '/sponsors', array('attributes' => array("style" => "color:$sponsors_menu"))) . '</li>';
                  }
                  ...
                  if (!empty($tab_menu['tab_top_menu'])) {
                    print '<li>' . $tab_menu['tab_top_menu'] . $tab_menu['tab_menu'] . '</li>';
                  }
                  ?>
              </ul>
          </div>
