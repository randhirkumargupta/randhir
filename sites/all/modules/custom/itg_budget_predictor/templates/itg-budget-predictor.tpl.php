        ...
        <div id="main-container-budget">
           ...
           <div class="social-list">
            <ul>
                ...
                <li class="mhide"><div id="fb-root"></div><a onclick="badget_fb_share('<?php print $actual_link;?>', '<?php print $budget_title; ?>', '<?php print $budget_description; ?>', '<?php print $file_name;?>')"><i class="fa fa-facebook"></i></a></li>
                <li class="mhide"><a href="javascript:" onclick="badget_twitter_share('<?php print urlencode($budget_title);?>', '<?php print urlencode($short_url); ?>')"><i class="fa fa-twitter"></i></a></li>
