...
<div class="hide">
    <form id="amex-form" action="<?php echo $base_url; ?>/itg-payment-amex-order-form-action" method="post" accept-charset="UTF-8">
        ...
        <table width="100%" align="center" border="0" cellpadding='0' cellspacing='0'>
            <tr class="shade">
                <td align="right"><strong><em><?php print t('Virtual Payment Client URL'); ?>:&nbsp;</em></strong></td>
            ...
            <tr class="shade">
                <td align="right"><strong><em><?php print t('Receipt ReturnURL'); ?>: </em></strong></td>
                <td><input name="vpc_ReturnURL" size="65" value="<?php echo VPC_RETURN_URL; ?>" maxlength="250"/></td>
            </tr>
            <tr>
                <td align="right"><strong><em><?php print t('Payment Server Display Language Locale'); ?>: </em></strong></td>
                <td>
            ...
            <tr class="shade">
                <td align="right"><strong><em><?php print t('Currency'); ?>: </em></strong></td>
                <td>
