...
<!--    <a class="btn btn-preview" href="javascript:void(0)" id="layout-button-preview">Preview</a>-->
    <a class="colorbox-load btn btn-preview" href="<?php print $base_url.'/itg-layout-manager/'.arg(1).'/preview/?section='.$_GET["section"].'&template_name='. $_GET["template_name"].'&width=900&height=700' ?>">Preview</a>
