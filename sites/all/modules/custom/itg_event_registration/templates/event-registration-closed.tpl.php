...
<h1><?php echo t('Thank you for visiting the page.'); ?></h1>
 ...
 <div class="buy-ticket-txt"><?php echo t('YOU CAN BY TICKETS FROM VENUE'); ?>: <a href="#" class="siri-audi-link"><?php print $node->field_story_kicker_text[LANGUAGE_NONE][0]['value']; ?></a> </br> <?php echo t('PLEASE CARRY A VALID PHOTO AND ID PROOF.'); ?></div>
  <?php
