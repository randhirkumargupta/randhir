...
<h1>Thank you for visiting the page.</h1>
 <div class="event-registration-link"><i class="fa fa-frown-o" aria-hidden="true"></i> Maybe this event is not published OR not found. <i class="fa fa-frown-o" aria-hidden="true"></i></div>
  <?php
