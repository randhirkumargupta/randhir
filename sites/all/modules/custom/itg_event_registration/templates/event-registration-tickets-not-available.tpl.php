...
<h1><?php print t('Thank you for visiting the page.'); ?></h1>
 <div class="event-registration-link"><i class="fa fa-frown-o" aria-hidden="true"></i> <?php print t('Tickets are not available now.'); ?> <i class="fa fa-frown-o" aria-hidden="true"></i></div>
 <?php
