	...
	var Cropit = (function () {
	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function init() {
	      ...
	      this.$preview = this.options.$preview.css({'position':'relative','left':'0','right':'0','margin':'auto'});
...
var imgdata=jQuery('#image-enc-data').val();
//alert(imgdata)

	      this.$image = (0, _jquery2['default'])('<img />').addClass(_constants.CLASS_NAMES.PREVIEW_IMAGE).attr('src', imgdata).css({
