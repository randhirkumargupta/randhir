<?php pr($data); if (!empty($data)) : global $base_url; ?>
  <div class="watch-right-now-video bestcollege-rhs-video">
    <?php $is_fron_page = drupal_is_front_page();
    if (empty($is_fron_page)) {
      ?><h3><span><?php print t("STORY") ?></span></h3><?php //print l('More', 'videos/', array('attributes' => array('class' => 'bestcollege-more-video'))); ?><?php } ?>
    <ul>
