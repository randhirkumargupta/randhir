...
(function($) {
    ...
    Drupal.behaviors.itg_story_sample_upload = {
        context: null,
        attach: function(context) {
            ...
            uploader.bind('UploadComplete', function() {
                ...
                $('#edit-field-story-technology-add-more-number').val(filenumber);
        ...
        complete: function() {
            $('input[name=field_story_technology_add_more]').mousedown();
            ...
            setTimeout(function() {
                ...
                $('#edit-field-story-technology-add-more-number').val(1);
