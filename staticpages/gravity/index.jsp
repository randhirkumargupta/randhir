...
.slider-prev {position: absolute; left: 0px; top: 215px; background:url(http://media2.intoday.in/indiatoday/specials/images/arrows_lft.png) no-repeat top left; width:45px; height:45px; text-indent:-9999px; cursor:pointer}
.slider-next {position: absolute; right: 3px; top: 215px;background:url(http://media2.intoday.in/indiatoday/specials/images/arrows_rt.png) no-repeat top left; width:45px; height:45px; text-indent:-9999px; cursor:pointer}
...
.story_slide {
    ...
    width: 1000px;
            ...
            .story_slide .left { position:absolute; background:url(http://media2.intoday.in/indiatoday/images/friends/Back-button.png) 5px 38px no-repeat; color:#fff; padding:10px; left:0px; top:150px; cursor:pointer; z-index:1; width:124px; height:74px  }

            .story_slide .right { position:absolute; background:url(http://media2.intoday.in/indiatoday/images/friends/Forward-button.png) 122px 38px no-repeat; color:#fff; padding:10px; right:0px; top:150px; cursor:pointer; z-index:1;  width:165px; height:74px  }
...
<div class="frm-share rght">
        <div class="socialcont">
            <div class="socialdiv">
                ...
                <a rel="nofollow" target="_new" title="Facebook" href="http://www.facebook.com/sharer/sharer.php?p[url]=http://indiatoday.intoday.in/gravity/&amp;p[title]=Gravity&amp;s=100&amp;p[summary]=Gravity&amp;p[images][0]=http://media2.intoday.in/indiatoday//images/slideshow/collage-1_100913080948.jpg"><span class="imgs fb lft"></span></a>
...
<div class="slider-right"><img src="http://media2.intoday.in/indiatoday//images/slideshow/collage-1_100913080948.jpg" border="0" >
</div>
</li>
...
<p style="margin-bottom:50px;"></p></div>
<div class="slider-right"><img src="http://media2.intoday.in/indiatoday//images/slideshow/collage-2_100913080948.jpg" border="0" >
</div>
</li>
<li>
...
<p style="margin-bottom:50px;"></p></div>
<div class="slider-right"><img src="http://media2.intoday.in/indiatoday//images/slideshow/collage-3_100913080948.jpg" border="0" >
</div>
</li>
...
<p style="margin-bottom:50px;"></p></div>
<div class="slider-right"><img src="http://media2.intoday.in/indiatoday//images/slideshow/collage-4_100913081302.jpg" border="0" >
</div>
</li>
...
<p style="margin-bottom:50px;"></p></div>
<div class="slider-right"><img src="http://media2.intoday.in/indiatoday//images/slideshow/collage-5_100913081302.jpg" border="0" >
</div>
</li>
...
<div id="leftrightads">
	<div class="leftad">
	<a href="http://election.intoday.in" target="_blank"><img src="http://media2.intoday.in/indiatoday/images/160X600-IT.GIF" border="0"></a>
	</div>
	<div class="rightad">
	<a href="http://election.intoday.in" target="_blank"><img src="http://media2.intoday.in/indiatoday/images/160X600-IT.GIF" border="0"></a>
	</div>
