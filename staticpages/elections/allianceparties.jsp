...
<title>NDA Alliance Result of Lok Sabha Elections 2014</title>
<meta name="description" content="NDA Alliance Results 2014 - Find live update of NDA parties leads won and NDA alliance total seats in parliament" />
<meta name="keywords" content="NDA alliance results 2014, NDA alliance 2014, NDA alliance parties" />
...
<div class="top-strip-one">
        ...
        <h2>Alliance</h2>
        <h3><a href="http://indiatoday.intoday.in/elections/2014/state/delhi.html" target="_blank">State</a></h3>
<h3><a href = "http://indiatoday.intoday.in/elections/2014/party/bjp.html" target = "_blank">PARTY</a></h3>  <h3><a href = "http://indiatoday.intoday.in/elections/2014/fullhousecompare.html" target = "_blank">PREVIOUS RESULTS</a></h3>
 </div>
...
<div style="position:relative; top:0px; right:11px; float:right;">
<select id="dynamic_select" style="padding:5px; background:#000; color:#fff; border:0;" onchange="javascript:location.href = this.value;">
<option value="#">OTHER ALLIANCE&nbsp; </option>
<option value="/elections/2014/alliance/nda.html">NDA</option>
<option value="/elections/2014/alliance/upa.html">UPA</option>
<option value="/elections/2014/alliance/oth.html">OTH</option>
</select>
</div>

 <div id="pieAllianceBigContainer" style="height: 400px; margin-bottom:-150px; border:1px solid #fff"></div>
 ...
 <script type = "text/javascript">getAlliancePartyDetails1("nda");
 </script>
	...
	<div id="pieAllianceSmallContainer_upa" style="min-width: 250px; height: 280px; max-width: 300px; margin: 0 auto"></div>
	<div style = "margin-top:-88px;position:relative;z-index:9999;" align = "center"><a href = "/elections/2014/alliance/upa.html" style = "color:#000;">View Details</a></div>
	<script>loadPieAllianceSmallContainer("upa");</script>
				</li>

					<li style="margin-left:70px">
	<div id="pieAllianceSmallContainer_oth" style="min-width: 250px; height: 280px; max-width: 300px; margin: 0 auto"></div>
	<div style = "margin-top:-88px;position:relative;z-index:9999;" align = "center"><a href = "/elections/2014/alliance/oth.html" style = "color:#000;">View Details</a></div>
	<script>loadPieAllianceSmallContainer("oth");</script>
				</li>
