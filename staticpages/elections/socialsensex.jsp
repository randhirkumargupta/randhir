...
#wapper-two { border:2px solid #dce3ed; box-shadow: 0 5px 12px #888888; height: 1983px; margin-bottom:10px; border-top:none; }
...
#iframe-chunk{ width:998px; margin:0 auto;}
...
.page-content{min-height: 1805px !important;}
#sesex-footer{background: none repeat scroll 0 0 #333333;
    color: #A9A9A9;
    font-family: roboto;
    font-size: 30px;
    font-weight: bold;
...
<script type="text/javascript" async>ajaxinclude("<//%=Constants.SITE_URL%>chunk_breakingnews.jsp")</script>
</div>-->
<div class="clear"></div>
...
CONNECT WITH US!  
 ...
 <map name="Map">
   ...
   <area shape="rect" coords="208,2,263,57" target="_blank" href="https://www.youtube.com/headlinestoday">
 </map>
</div>
