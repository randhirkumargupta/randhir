...
<div class="top-strip-one">
             <h2 style='margin-left:12px;'>Tally</h2><h3><a href="/" target="_blank">Full house</a></h3>
        <h3><a href="/elections/2014/alliance/nda.html" target="_blank">Alliance</a></h3>
         <h3><a href="/elections/2014/state/delhi.html" target="_blank">State</a></h3> 
<h3><a href="/elections/2014/party/bjp.html" target="_blank">PARTY</a></h3>  <h3><a href = "/elections/2014/fullhousecompare.html" target = "_blank">PREVIOUS RESULTS</a></h3> 
 </div> 
...
<div class="con-chunk">
    <div class="top-strip" style="border:1px solid #E2E2E2; overflow:hidden; border-bottom:none; width:658px; border-right:solid 2px #E2E2E2; border-left:solid 2px #E2E2E2; margin-left:-2px;">
        <span style="width:300px; border:none"><h2>India</h2></span>
        <div style="position:relative; top:0px; float:right;">
<select onchange="javascript:location.href = this.value;" style="padding:5px; background:#000; color:#fff; border:0;" id="dynamic_select">
<option value="#">SELECT STATE</option>
<option value="/elections/2014/state/andaman-nicobar-islands.html">Andaman Nicobar Islands</option><option value="/elections/2014/state/andhra-pradesh.html">Andhra Pradesh</option><option value="/elections/2014/state/arunachal-pradesh.html">Arunachal Pradesh</option><option value="/elections/2014/state/assam.html">Assam</option><option value="/elections/2014/state/bihar.html">Bihar</option><option value="/elections/2014/state/chandigarh.html">Chandigarh</option><option value="/elections/2014/state/chhattisgarh.html">Chhattisgarh</option><option value="/elections/2014/state/dadra-nagar-haveli.html">Dadra Nagar Haveli</option><option value="/elections/2014/state/daman-and-diu.html">Daman and Diu</option><option value="/elections/2014/state/delhi.html">Delhi</option><option value="/elections/2014/state/goa.html">Goa</option><option value="/elections/2014/state/gujarat.html">Gujarat</option><option value="/elections/2014/state/haryana.html">Haryana</option><option value="/elections/2014/state/himachal-pradesh.html">Himachal Pradesh</option><option value="/elections/2014/state/jammu-and-kashmir.html">Jammu and Kashmir</option><option value="/elections/2014/state/jharkhand.html">Jharkhand</option><option value="/elections/2014/state/karnataka.html">Karnataka</option><option value="/elections/2014/state/kerala.html">Kerala</option><option value="/elections/2014/state/lakshadweep.html">Lakshadweep</option><option value="/elections/2014/state/madhya-pradesh.html">Madhya Pradesh</option><option value="/elections/2014/state/maharashtra.html">Maharashtra</option><option value="/elections/2014/state/manipur.html">Manipur</option><option value="/elections/2014/state/meghalaya.html">Meghalaya</option><option value="/elections/2014/state/mizoram.html">Mizoram</option><option value="/elections/2014/state/nagaland.html">Nagaland</option><option value="/elections/2014/state/odisha.html">Odisha</option><option value="/elections/2014/state/puducherry.html">puducherry</option><option value="/elections/2014/state/punjab.html">Punjab</option><option value="/elections/2014/state/rajasthan.html">Rajasthan</option><option value="/elections/2014/state/sikkim.html">Sikkim</option><option value="/elections/2014/state/tamil-nadu.html">Tamil Nadu</option><option value="/elections/2014/state/tripura.html">Tripura</option><option value="/elections/2014/state/uttarakhand.html">Uttarakhand</option><option value="/elections/2014/state/uttar-pradesh.html">Uttar Pradesh</option><option value="/elections/2014/state/west-bengal.html">West Bengal</option>
</select>
</div>
    ...
    <div class="box-poll-shadow">
      <span style="border-top:0px"><h2 style="font-size:12px; background:none; color:#000; padding-top:10px; padding-left:5px">Click on map to see constituency-wise result</h2></span>
    
    	<div style="position:relative;">
<div>
<div id = "indiamap"></div>
<script>getindia();</script>
</div>
