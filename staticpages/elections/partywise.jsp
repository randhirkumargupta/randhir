...
<title>General Elections 2014 - Party</title>
<meta name="description" content="General Elections 2014 - Party" />
<meta name="keywords" content="General Elections 2014 - Party" />
...
<h2>PARTY</h2>  <h3><a href = "/elections/2014/fullhousecompare.html" target = "_blank">PREVIOUS RESULTS</a></h3> 
...
.schedule tbody tr td {padding: 10px 10px 10px 5px;}
</style>
<div id="wrapper">

<div style="margin-bottom:-70px;"><img src = "https://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/election2014/party_logo/null.jpg" width="100" height="100" ></div>
...
<option value="#">OTHER PARTIES&nbsp; </option>
<option value="/elections/2014/party/inc.html">INC</option>
<option value="/elections/2014/party/bjp.html">BJP</option>
<option value="/elections/2014/party/bsp.html">BSP</option>
<option value="/elections/2014/party/cpi.html">CPI</option>
<option value="/elections/2014/party/cpi(m).html">CPI(M)</option>
<option value="/elections/2014/party/ncp.html">NCP</option>
</select>
</div>


	<div style="position:relative">
           <table width="100%" border="0" cellspacing="0" cellpadding="8" class="schedule" id="partyTable">
            </table>
        </div>
