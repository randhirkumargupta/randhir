...
.venuetitle { color:#000!Important}
    ...
    ALIGN="CENTER">
      ...
      <DIV>
		  ...
		  <div class="progbgbox" style="min-height:500px;">
		<img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/psu/sponsors-img.jpg" usemap="#Map2" border="0" title="sponsors">
        <map name="Map" id="Map2">
          <area shape="rect" coords="45,28,126,104" href="http://www.bsnl.co.in/" target="_blank" />
          <area shape="rect" coords="379,39,531,80" href="https://www.microsoft.com/en-in/" target="_blank" />
        </map>
