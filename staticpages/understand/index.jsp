...
<title>Understand with Funalytics</title>
<meta name="description" content="Understand with Funalytics" />
<meta name="keywords" content="Understand with Funalytics" />
...
.color a, .color a:hover {color:#002F59;}
.vidpath {
    background: url("http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/video_bg1.gif") repeat-x scroll left top transparent;
    color: #FFFFFF;
    float: right;
    height: 27px;
    padding-right: 7px;
...
.pushertopad {margin:0 auto; width:1003px;margin:0 auto;text-align: center;}
.maincontainer {background-image: url('http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/bg-strip.gif'); background-repeat:repeat-x; width:100%; overflow:hidden}
...
#fun-container { margin:0 auto; width:1000px;}
.container img { margin:10px 15px;}
.nextarrow {
    background: url("../images/India-Today-Sprites2.png") no-repeat scroll -228px -5px transparent;
    height: 65px;
    position: absolute;
    right: 10px;
    text-indent: -9999px;
...
.prevarrow {
    background: url("../images/India-Today-Sprites2.png") no-repeat scroll -302px -5px transparent;
    height: 65px;
    left: 10px;
    position: absolute;
    text-indent: -9999px;
...
#wrappercont {width:100%; background-color:#fff;}
.clear { clear:both;}
				...
				/*.frm-share{ background:url(images/womens-day.jpg) no-repeat 0 0;}*/
				.rght { float:right}
				.socialcont {
					position: absolute;
					right: 0;
...
#slides .next,#slides .prev {position:absolute;top:35%;width:62px;height:60px;display:block;z-index:101;opacity: 0.5;filter:alpha(opacity=50);}
...
.submit_button{  background-image: url("../images/str_sub.gif");background-position: left top;background-repeat: no-repeat;border: medium none;cursor: pointer;float: left;height: 21px;margin: 0;padding: 0;width: 67px;}
...
#leftrightads{ display:none;}
	nav ul li a, nav ul li a:hover {text-decoration:none !important;}
	.menues {z-index:0 !important;}
</style>
...
<script type="text/javascript">
	...
	$(document).ready( function() {
		...
		$('#wrappercont .img').click( function() {
			loadPopupBox();
		});
...
<a href="javascript:void(0);" id="img0" onclick="showImg(0, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_mos_100517015522.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_100517015522.jpg" title="" width="300" height="350" border="0" class="img" /></a>

<a href="javascript:void(0);" id="img1" onclick="showImg(1, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit-1_100417102140.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_mos_100417102140.jpg" title="" width="300" height="350" border="0" class="img" /></a>

<a href="javascript:void(0);" id="img2" onclick="showImg(2, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_100317120659.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_mos_100317120659.jpg" title="" width="300" height="350" border="0" class="img" /></a>

<a href="javascript:void(0);" id="img3" onclick="showImg(3, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_mos_092917082259.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit-1_092917082259.jpg" title="" width="300" height="350" border="0" class="img" /></a>

<a href="javascript:void(0);" id="img4" onclick="showImg(4, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_300x350_092817082411.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_1003_092817082411.jpg" title="" width="300" height="350" border="0" class="img" /></a>

<a href="javascript:void(0);" id="img5" onclick="showImg(5, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_300x350_092817074501.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit-1_1003_092817074502.jpg" title="" width="300" height="350" border="0" class="img" /></a>

<a href="javascript:void(0);" id="img6" onclick="showImg(6, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_300x350_092717074607.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit-1_1003_092717074607.jpg" title="" width="300" height="350" border="0" class="img" /></a>

<a href="javascript:void(0);" id="img7" onclick="showImg(7, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit-1_1003_092617082151.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/" title="" width="300" height="350" border="0" class="img" /></a>

<a href="javascript:void(0);" id="img8" onclick="showImg(8, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_300x350_092017093340.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit-1_1003_092017093340.jpg" title="" width="300" height="350" border="0" class="img" /></a>

<a href="javascript:void(0);" id="img9" onclick="showImg(9, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_300x350_092017093134.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_1003_092017093134.jpg" title="" width="300" height="350" border="0" class="img" /></a>

<a href="javascript:void(0);" id="img10" onclick="showImg(10, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_300x350_091517091106.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_1003_091517091106.jpg" title="" width="300" height="350" border="0" class="img" /></a>

<a href="javascript:void(0);" id="img11" onclick="showImg(11, 0, 12);"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_300x350_091517091106.jpg" bigsrc="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/visual-edit_1003_091517091106.jpg" title="" width="300" height="350" border="0" class="img" /></a>

</div>
<script type="text/javascript">
var maxCounter=959-1;
function showImg(counter, startNo, endNo) {
	//alert(counter+"----"+startNo+"----"+endNo);
	var htmlimg = $('#img'+counter+' > img').attr('bigsrc');
	$('.popup_box').show(10);
	$('#wrappercont').css({'opacity' : '0.5', 'background-color':'#000' });
	if(counter<endNo-1){
	//pageTracker._trackPageview(''+counter+'#BN');
		_gaq.push(['_trackPageview', 'http://indiatoday.intoday.in/understand/index.jsp?page=1&imgId='+counter+'#BN']);
		var next = '<a href="javascript:void(0);" onclick="showImg('+(parseInt(counter)+1)+', '+startNo+', '+endNo+');" class="nextarrow">Next</a>';
	} else {
		var next = '';
	}
	if(counter>startNo){
	//pageTracker._trackPageview(''+counter+'#BN');
		_gaq.push(['_trackPageview', 'http://indiatoday.intoday.in/understand/index.jsp?page=1&imgId='+counter+'#BN']);
	 	var prev = '<a href="javascript:void(0);" onclick="showImg('+(parseInt(counter)-1)+', '+startNo+', '+endNo+');" class="prevarrow">Previous</a>';
	} else {
		var prev = '';
	}
	//alert(""+htmlimg);

	var socialshare ='<div class="frm-share rght"><div class="socialcont"><div class="socialdiv"><a href="http://www.facebook.com/sharer.php?u='+htmlimg+'" title="Facebook" target="_new" rel="nofollow"><span class="imgs fb lft"></span></a><a href="http://twitter.com/?status='+htmlimg+'%20via%20%40indiatoday" title="Twitter" target="_new" rel="nofollow"><span class="imgs tw lft"></span></a></div></div></div>';
	$('#fun-container').css("display","block");
	$('#popimg').html(socialshare+next+prev+'<img src="'+htmlimg+'">');
...
<strong>1</strong>&nbsp;&nbsp;
 ...
 <a href="index.jsp?page=5">5</a>&nbsp;&nbsp;
<span class="color"><a href="index.jsp?page=6">Next ></a></span>&nbsp;&nbsp;
<span class="color"><a href="index.jsp?page=80">>></a></span>
