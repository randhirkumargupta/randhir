...
.commentfrm input.submit_button {
    background: url("/staticpages/main/images/sms-popup-check.jpg") repeat scroll 0 0 transparent;
    border: medium none;
    cursor: pointer;
    float: left;
    height: 21px;
...
<a name="comment"></a>
  ...
  <tr><td align="left" colspan="2"><img align="absmiddle" class="postimg" src="/staticpages/main/images/post-comment_icon.gif"><strong style="padding-left: 10px">Post your comments</strong></td></tr>
