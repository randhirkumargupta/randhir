<!DOCTYPE html><html lang="en">
  <head>
    <meta charset="utf-8">
<title>Boss, Bollywood, Entertainment</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="description" content="Reviews of Boss starring Akshay Kumar, Mithun Chakraborty, Ronit Roy, Shiv Pandit, Aditi Rao Hydri." />
<meta name="keywords" content="Boss, Akshay Kumar, Mithun Chakraborty, Ronit Roy, Shiv Pandit, Aditi Rao Hydri, Bollywood, Movie review, Boss review, Videos, Photos" />
...
<div class="seclist"><div class="secname">Movies</div><div class="secother">
			<span><a href="/category/gossip/1/136.html">Gossip</a></span>
			 | 
			<span><a href="/category/reviews/1/137.html">Reviews</a></span>
			 | 
			<span><a href="/category/bollywood/1/139.html">Bollywood</a></span>
			 | 
			<span><a href="/category/celebrities/1/135.html">Celebrities</a></span>
			 | 
			<span><a href="/category/hollywood/1/138.html">Hollywood</a></span>
			</div></div>
<!--<div class="tagsRow"><span class="tag-title">Tags: </span><a class="tags" href="/advanced_search.jsp?searchword=Shuddh Desi Romance&amp;searchtype=text&amp;search_type=article">Shuddh Desi Romance</a> | <a class="tags" href="/advanced_search.jsp?searchword=Shushant Singh Rajput&amp;searchtype=text&amp;search_type=article"> Shushant Singh Rajput</a> | <a class="tags" href="/advanced_search.jsp?searchword=Parineeti Chopra&amp;searchtype=text&amp;search_type=article"> Parineeti Chopra</a> | <a class="tags" href="/advanced_search.jsp?searchword=Vani Kapoor&amp;searchtype=text&amp;search_type=article"> Vani Kapoor</a> | <a class="tags" href="/advanced_search.jsp?searchword=Rishi Kapoor&amp;searchtype=text&amp;search_type=article"> Rishi Kapoor</a> | <a class="tags" href="/advanced_search.jsp?searchword=Maneesh Sharma&amp;searchtype=text&amp;search_type=article"> Maneesh Sharma</a></div>-->

<div class="pathway"><div class="path lft">
<div class="lft" itemtype="http://data-vocabulary.org/Breadcrumb" itemscope=""><a itemprop="url" href="http://indiatoday.intoday.in/"><span itemprop="title">India Today</span></a>
&nbsp;/&nbsp;</div>

<div class="lft" itemtype="http://data-vocabulary.org/Breadcrumb" itemscope=""><a href="/section/67/1/movies.html" itemprop="url"><span itemprop="title">Movies</span></a>&nbsp;/&nbsp;</div> <div class="lft" itemtype="http://data-vocabulary.org/Breadcrumb" itemscope=""><a href="#" itemprop="url"><span itemprop="title">Reviews</span></a>&nbsp;/&nbsp;</div>Story</div>
...
.lft {float:left;}
.right {float:right}
.mov-left-cont {width:455px; float:left}
.mov-cont {border-bottom:1px dotted #ccc; margin-bottom:15px;}
.movie-head {font:bold 16px/20px arial; color:#000;}
.movie-head a {color:#000; text-decoration:none;}
.movie-head a:hover {text-decoration:underline;}

.mov-byline {
    color: #0380CF;
    float: left;
    font: bold 12px/18px arial; font-style:italic;
}
...
.mov-star {
    background: url("http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/megareview/b-star.png") no-repeat scroll left top transparent;
    display: inline;
    float: left;
    height: 15px;
    margin: 0 1px;
...
.mov-star-half {background:url(http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/megareview/b-star1.png) no-repeat top left; width:16px; height:15px; float:left; margin:0 1px;}
.kicker {font:normal 14px/20px Georgia; color:#000; padding:5px 0 15px 0;}
.kicker a {color:#000; text-decoration:none;}
.kicker a:hover {text-decoration:underline;}
.readmore {color:#dc0c17; float:none !important}
.readmore a {color:#dc0c17; text-decoration:none;}
.readmore a:hover {text-decoration:underline;}

.mov-right-cont {width:188px; float:right;}
.mov-headline {background-color:#000;font:bold 18px/22px arial; padding:5px 10px; color:#fff;}
.mov-inner-cont {padding:10px 10px 0 10px; border:1px solid #000;}
.cont-movies {width:167px;float:left; margin-bottom:10px; }
.cont-movies .box {width:167px; height:125px;position:relative;}
.cont-movies .box .vid {position:absolute; bottom:5px; right:5px;}
.cont-movies .head {font:bold 16px/20px arial;color:#000;margin-top: 5px;}
.cont-movies .head a {color:#000; text-decoration:none;}
.cont-movies .head a:hover {text-decoration:underline}
.cont-movies .text {font:bold 12px/18px arial;color:#343131}
.cont-movies .text a {color:#343131; text-decoration:none;}
.cont-movies .text a:hover {text-decoration:underline}
.marg-bott { margin-bottom:20px;}


.movie-topcont {width:660px; float:left; margin-bottom:20px;}
...
.mov-top-list {
    ...
    float: left;
    font: 14px/20px Arial Black;
    height: 32px;
    margin-left: -10px;
    width: 660px;
}
.mov-top-list ul {margin:0; padding:0;}
.mov-top-list ul li {
    color: #7F7F7F;
    float: left;
...
.mov-top-list ul li.active {
    background-color: #FBE919;
    color: #000000;
    padding-bottom: 8px;
}

.mov-top-head {font:bold 28px/32px arial; color:#c4c3c3; margin-top: 10px;}
.white {color:#fff;}
.mov-strap {font:bold 12px arial; color:#999;}
.ourreview {
    color: #FCE700;
...
.movie-bg {
    background: url("http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/megareview/bg.png") repeat-x scroll left bottom transparent;
    float: left;
    width: 100%;
}
.rating {font:normal 24px/16px arial black; color:#dc0c17}
.startop {font:bold 14px/20px arial; color:#585858}
section#left {
    border-right: 0 none;
    float: right;
}
</style>
<div style="width:660px; float:left; margin-bottom:30px;">

<div class="movie-topcont">
<div class="movie-bg"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/megareview/mega.png" border="0" align="left"></div>
<div class="clear"></div>
<div class="mov-top-bg">
<!--<div class="mov-top-list">
<ul>
 <li class="active">Shuddh desi romance</li>
<li>ooops a desi</li>
<li>zanjeer</li>
<li>satyagraha</li>
</ul>
...
<div class="mov-top-head"><span class="white">Boss</span></div>
<div class="mov-strap"><!-- <em>By Rohit Khilnani</em> September 9, 2013 | Update 13:52 IST --></div>


<div style="width:350px; float:left; margin-top:15px;">
<iframe width="354" height="315" src="http://www.youtube.com/embed/zaoDtl0GL2E" frameborder="0" allowfullscreen></iframe>


<!-- 
<img src=" http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/wonderwoman/images/stories/Decemcer2011/besharam350_100213050829.jpg" border="0">
 -->
<div class="clear"></div>
<div style="margin-top:5px; float:left; width:100%;">
<div style="float:left; font:bold 14px arial;color:#fff; width:60px; padding:0 10px;">Cast</div>
<div style="font:normal 14px/20px arial;color:#999999;">Akshay Kumar, Mithun Chakraborty, Ronit Roy, Shiv Pandit, Aditi Rao Hydri</div>
</div>
<div style="margin-top:5px; float:left; width:100%;">
<div style="float:left; font:bold 14px arial;color:#fff; width:60px; padding:0 10px 10px 10px;">Director</div>
<div style="font:normal 14px/20px arial;color:#999999;">Anthony D'Souza </div>
</div>
</div>

<div style="float:right;width:285px; min-height:300px; margin-top:15px; background:url(http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/megareview/star-bg.png) no-repeat top right; text-align:left; font:normal 14px arial; color:#fff;">

<div style="width:142px; float:left">
<div class="ourreview">Our Reviewers</div>
<div class="can-name"><a href="http://indiatoday.intoday.in/story/boss-review-akshay-kumar/1/316560.html"  style="color:white;" target="_NEW">Suhani Singh</a><br><span class="mov-star"></span><span class="mov-star"></span><div class="clear"></div></div>
<div class="can-name"><a href="http://indiatoday.intoday.in/story/boss-review/1/316537.html"  style="color:white;" target="_NEW">Vinayak Chakravorty</a><br><span class="mov-star"></span><span class="mov-star"></span><div class="clear"></div></div>
<div class="can-name"><a href="http://indiatoday.intoday.in/story/movie-review-of-akshay-kumars-boss/1/316505.html"  style="color:white;" target="_NEW">Rohit Khilnani</a><br><span class="mov-star"></span><span class="mov-star-half"></span><div class="clear"></div></div>
<div class="can-name"><a href="http://indiatoday.intoday.in/story/movie-review-boss/1/316524.html"  style="color:white;" target="_NEW">Faheem Ruhani</a><br><span class="mov-star"></span><span class="mov-star"></span><div class="clear"></div></div>
<div class="can-name"><a href="http://indiatoday.intoday.in/story/movie-review-boss-fails-to-deliver/1/316541.html"  style="color:white;" target="_NEW">Saurabh Dwivedi</a><br><span class="mov-star"></span><span class="mov-star"></span><div class="clear"></div></div>
</div>

<div style="width:50px; float:right; margin-right:16px; margin-top:120px;" class="rating">2<span class="startop" style="float: right;
    font-size: 24px;
    margin-right: 23px;
    margin-top: 3px;
    width: 40px;">star</span></div>
...
<div class="mov-left-cont" style="width:386px;">

<div class="mov-cont">
	<div class="movie-head">Yet another film which brings little creativity</div>
    <span class="mov-byline">By Suhani Singh, India Today</span> <span class="mov-date">October 16, 2013</span><span class="mov-star"></span><span class="mov-star"></span>
    <div class="clear"></div>
    <div class="kicker">Boss is a formulaic action-comedy in which the only risk the makers take is to not give the hero a heroine. But that doesn't stop Kumar to rope in Sonakshi Sinha to dance with him in two songs. <span class="readmore"><a href="http://indiatoday.intoday.in/story/boss-review-akshay-kumar/1/316560.html">Read More</a></span></div>
</div>

<div class="mov-cont">
	<div class="movie-head">Boss simply goes for a toss</div>
    <span class="mov-byline">By Vinayak Chakravorty, Mail Today</span> <span class="mov-date">October 16, 2013</span><span class="mov-star"></span><span class="mov-star"></span>
    <div class="clear"></div>
    <div class="kicker">Boss once again underlines the aimlessness that has largely dominated Akshay's career in his race for the top. The film rides his stardom from the moment he enters the frame about 40 minutes into the runtime. <span class="readmore"><a href="http://indiatoday.intoday.in/story/boss-review/1/316537.html">Read More</a></span></div>
</div>


<div class="mov-cont">
	<div class="movie-head">It's a mindless film</div>
    <span class="mov-byline">By Rohit Khilnani, Headlines Today</span> <span class="mov-date">October 16, 2013</span><span class="mov-star"></span><span class="mov-star-half"></span>
    <div class="clear"></div>
    <div class="kicker">The posters and the promos of the film make it clear that Boss is a masala film. And going by the recent trend, for masala films, all that's needed is a "filmi" hero, cars flying around and some "nach gaana". Who cares about the plot and the product? <span class="readmore"><a href="http://indiatoday.intoday.in/story/movie-review-of-akshay-kumars-boss/1/316505.html">Read More</a></span></div>
</div>


<div class="mov-cont">
	<div class="movie-head">Sorry Boss, you have gone for a toss</div>
    <span class="mov-byline">By Faheem Ruhani, India Today</span> <span class="mov-date">October 16, 2013</span><span class="mov-star"></span><span class="mov-star"></span>
    <div class="clear"></div>
    <div class="kicker">The story, plot be damned, let's just do anything as Akshay Kumar says, "Apne ko toh bas paani nikalne ka."  Does it mean we are just interested in reaching the Rs.100-crore mark? And that's why we made this film?  <span class="readmore"><a href="http://indiatoday.intoday.in/story/movie-review-boss/1/316524.html">Read More</a></span></div>
</div>

<div class="mov-cont">
	<div class="movie-head">It fails to deliver</div>
    <span class="mov-byline">Saurabh Dwivedi </span> <span class="mov-date">October 16, 2013</span><span class="mov-star"></span><span class="mov-star"></span>
    <div class="clear"></div>
    <div class="kicker">Wake up Akki! He should not forget that just like the Khan brigade, he too has a massive fan following which guarantees a smashing opening for all his films. But after that, the story just takes a wrong turn and lands up as a box office disaster. <span class="readmore"><a href="http://indiatoday.intoday.in/story/movie-review-boss-fails-to-deliver/1/316541.html">Read More</a></span></div>
</div>

<div class="mov-cont">
	<div class="movie-head">Boss is not always right!</div>
    <span class="mov-byline">Times Of India</span> <span class="mov-date">October 16, 2013</span>
    <div class="clear"></div>
    <div class="kicker">While on one side it's said that the boss is always right, on the other side not many look up to a boss who is unable to look beyond himself. The choice is yours! <span class="readmore"><a href="http://timesofindia.indiatimes.com/entertainment/bollywood/news-interviews/Boss-is-not-always-right/articleshow/24212117.cms?" target="_NEW">Read More</a></span></div>
</div>

<div class="mov-cont">
	<div class="movie-head">A load of mindless dross</div>
    <span class="mov-byline">NDTV</span> <span class="mov-date">October 16, 2013</span><span class="mov-star"></span><span class="mov-star"></span>
    <div class="clear"></div>
    <div class="kicker">Boss is an action flick in which both logic and good taste go for a toss from the moment it kicks off. The humour is cringingly coarse, the stunts are completely over the top and the emotions never ring true. <span class="readmore"><a href="http://movies.ndtv.com/movie-reviews/boss-movie-review-886" target="_NEW">Read More</a></span></div>
</div>

<div class="mov-cont">
	<div class="movie-head">Akshay Kumar, Mithun team up to give you a headache</div>
    <span class="mov-byline">Firstpost</span> <span class="mov-date">October 16, 2013</span><span class="mov-star"></span><span class="mov-star"></span>
    <div class="clear"></div>
    <div class="kicker">Starring Akshay Kumar from Rowdy Rathore, Akshay Kumar from Khiladi 786 and Akshay Kumar from OUATIMB, Boss is one of the most shoddily-directed, pathetically-written and mind numbingly insipid expenditures of two and a half hours that you'll have subjected yourself to this year. <span class="readmore"><a href="http://www.firstpost.com/bollywood/boss-review-akshay-kumar-mithun-team-up-to-give-you-a-headache-1174565.html" target="_NEW">Read More</a></span></div>
</div>

<div class="mov-cont">
	<div class="movie-head">It has everything that spectators look for in masala fares</div>
    <span class="mov-byline">Bollywood Hungama</span> <span class="mov-date">October 16, 2013</span><span class="mov-star"></span><span class="mov-star"></span><span class="mov-star"></span><span class="mov-star"></span>
    <div class="clear"></div>
    <div class="kicker">It is *not* for those who find it fashionable to run down masala films. This one's for those who feast on unadulterated, pure desi entertainers with glee. <span class="readmore"><a href="http://www.bollywoodhungama.com/moviemicro/criticreview/id/566663" target="_NEW">Read More</a></span></div>
</div>
...
<div class="mov-right-cont" style="width:260px">

<div style="width:260px; height:500px;margin-bottom:20px;">
         <a class="twitter-timeline" width="260" height="500"  href="https://twitter.com/search?q=%23Boss"  data-widget-id="390428214457139200">Tweets about "#Boss"</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>

</div>
<div class="mov-headline">Movie Videos</div>
<div class="clear"></div>

<div class="mov-inner-cont">

<div class="cont-movies" style="padding-left:16px;width:202px;text-align:center;">
<div class="box"  style="padding-left:19px;"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/2013October/aditi_167_101613033002.jpg" border="0"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/megareview/video-icon.png" border="0" class="vid"></div>
<div class="head"><a href="http://indiatoday.intoday.in/video/first-look-aditi-shiv-pandit-steaming-chemistry-in-new-song/1/311296.html">Aditi's glamorous avatar in Boss</a></div>
<div class="text"><a href="http://indiatoday.intoday.in/video/first-look-aditi-shiv-pandit-steaming-chemistry-in-new-song/1/311296.html">Aditi Rao Hydari, the cute-as-a-button actress, is pushing the sensuous buttons now. She has sported bikini in Boss and is seen romancing Shiv Pandit.</a></div>
</div>

<div class="clear"></div>
</div>

<div class="clear marg-bott"></div>

<div class="mov-headline">Photos</div>
<div class="clear"></div>

<div class="mov-inner-cont">

<div class="cont-movies" style="padding-left:16px;width:202px;text-align:center;">
<div class="box"  style="padding-left:19px;"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/2013October/akshay_167_101613033008.jpg" border="0"></div>
<div class="head"><a href="http://indiatoday.intoday.in/gallery/boss-akshay-kumar-drives-down-on-jet-ski-for-media-meet/1/10232.html">Boss Akshay Kumar drives down on jet ski</div>
<div class="text"><a href="http://indiatoday.intoday.in/gallery/boss-akshay-kumar-drives-down-on-jet-ski-for-media-meet/1/10232.html">Akshay Kumar did something which has never been done before to promote his film Boss. The actor addressed the media on a yacht and made his entry on a jet ski. </div>
</div>

<div class="cont-movies" style="padding-left:16px;width:202px;text-align:center;">
<div class="box"  style="padding-left:19px;"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/2013October/akshay2_167_101613033002.jpg" border="0"></div>
<div class="head"><a href="http://indiatoday.intoday.in/gallery/hrithik-&-akshay-rock-the-dandiya-night/1/10320.html">Akshay promotes Boss celebrating Dussehra</div>
<div class="text"><a href="http://indiatoday.intoday.in/gallery/hrithik-&-akshay-rock-the-dandiya-night/1/10320.html">Akshay promoted his film in many unique ways. He also celebrated Dussehra with his fans at Lal Qila Maidaan in New Delhi. </div>
</div>
...
<div class="clear"></div>
<script type="text/javascript">
ajaxinclude("/commentbox/comment_box.jsp?sId=&website=indiatoday&content_type=phataposternikhlaheroreviews&ScfUrl=phataposternikhlaheroreviews.jsp&StoryTitle=phataposternikhlaheroreviews&message=&sectionInfo=");</script>

<script type="text/javascript">
ajaxinclude("topstories_storypage_chunk.jsp?primaryCatId=67~135")
</script>
</section>
<section id="right">
...
<div class='item'><div class='puff'><div class='mostpopulartext'><span>Sports</span><span class='lightcolor'>Buzz</span></div><ul class=''><li><a href="story/john-hastings-retirement-australia-cricket/1/1063089.html"><img src="http://indiatoday.intoday.in/images/lazyload-grey.gif" class="imglazyload" data-original="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/hastings_180_100617064729.jpg"  alt="cricket.com.au Twitter Photo" title="cricket.com.au Twitter Photo"  width='167' height='125' border='0'><span class='pufftext'><div class='pufftitle'>John Hastings announces retirement from ODI and first-class cricket</div><p> 
                                                    ...
                                                    </p></span></a></li><li><a href="story/ben-stokes-australia-vs-england-ashes-test-cricket/1/1063010.html"><img src="http://indiatoday.intoday.in/images/lazyload-grey.gif" class="imglazyload" data-original="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/stokes180_100617053113.jpg"  alt="(Reuters Photo)" title="(Reuters Photo)"  width='167' height='125' border='0'><span class='pufftext'><div class='pufftitle'>Ben Stokes dropped from England's Ashes squad over Bristol arrest</div><p> 
                                                     
                                                     
                                                     
                                                     
                                </p></span></a></li><li><a href="story/andres-iniesta-fc-barcelona-football/1/1062962.html"><img src="http://indiatoday.intoday.in/images/lazyload-grey.gif" class="imglazyload" data-original="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/iniesta_180_100617045436.jpg"  alt="(Reuters Photo)" title="(Reuters Photo)"  width='167' height='125' border='0'><span class='pufftext'><div class='pufftitle'>Andres Iniesta agrees 'contract for life' with Barcelona</div><p> 
                                                     
                                                     
                                                     
                                                     
                                </p></span></a></li><li><a href="story/bhuvneshwar-kumar-engaged-nupur-nagar/1/1062947.html"><img src="http://indiatoday.intoday.in/images/lazyload-grey.gif" class="imglazyload" data-original="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/bhuvi_bhabi_180_100617043728.jpg"  alt="Twitter Photo" title="Twitter Photo"  width='167' height='125' border='0'><span class='pufftext'><div class='pufftitle'>Bhuvneshwar Kumar gets engaged to 'better-half' Nupur Nagar</div><p> 
...
<div class="fotborder">
    	<footer>        	
            <script type="text/javascript">ajaxinclude("http://indiatoday.intoday.in/chunk_social_strip.html")</script>
<div class="clear"></div>
<div class="footband">
<ul>
	<li><a href="http://indiatoday.intoday.in/">Home</a></li>
