...
<script>
  ...
  ga('send', 'pageview');
    ...
    <link rel="alternate" media="only screen and (max-width: 640px)" href="/itmi/mobile/eligibility-criteria.jsp"/>	
...
<!--Body Content Start Here-->        
          ...
          <div></div>
              ...
              <ol style=" float:left; margin-left:30px;">
                <li>Registration fee is non-refundable.</li>
                <li>While every eligible candidate will be invited to enter the admission process, ITMI panel's decision on admission is final, and will be based on <br><br>
                &nbsp;&nbsp;&nbsp; a) test and interview scores, <br>
                &nbsp;&nbsp;&nbsp; b) essay score, <br>
                &nbsp;&nbsp;&nbsp; c) interviewer's remarks, <br>
                &nbsp;&nbsp;&nbsp; d) your academic background, <br>
                &nbsp;&nbsp;&nbsp; e) any demonstration of special qualities, <br>
                &nbsp;&nbsp;&nbsp; f) Dean's final approval.<br>
                <li>Once you register, an application form will be sent to you to be filled out completely. Academic and other documents must be attached to the form . Return the form at the test / interview venue.</li>
                <li>Initial deposit must be made as outlined in admission letter in order to book your seat at ITMI.</li>
                <li>All disputes with reference to admission to the Institute is subject to the exclusive jurisdiction of Delhi Courts.</li>
              </ol>
          <div></div>
              <p>.</p>
