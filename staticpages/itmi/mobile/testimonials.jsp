...
<style>
 ...
 .testimonial-outer{ box-shadow: 0px 0px 5px #ccc; padding: 15px; float: left; width: 100%; box-sizing: border-box; margin-bottom:30px;}
.testimonial-outer img{ float:left; margin-right:20px;}
.testimonial-outer h3 {display:table; font-weight:bold; margin-bottom:10px; margin-top: 15px; text-transform:uppercase;}
