...
<div class="clear"></div>
	<div class="sponsor_section">
     ...
     <h2>PRIYAGOLD</h2>
     <div style="clear:both;"></div>
   <p>We at PRIYAGOLD are producing quality product since 1992 and have thus acquire an extensive expertise in manufacturing BISCUITS, JUICES, CONFECTIONERY & CHOCOLATE. We are in one of the top leading companies of India producing Biscuits and confectionery companies with the annual production of around 300,000 M.Tons .<br/><br/>
 Our product range includes Butter Biscuits, Premium Cookies, Cream Biscuits & Cream Wafers, Marie, Crackers (Cheese, Sweet & Salty), Glucose Biscuits, Juices, Fruit drinks, Chocolate, Candy, Eclairs and many more.  We are all set to show case our complete range of quality products during the show Gulfood-2014 as it is the biggest platform to cater globally!<br/><br/>
Our vision is to cater all consumer segments worldwide from low end to high end, our Tag line reveal the same "HAQ SE MAANGO!!" as a result of today our range is being liked globally by one and all. 
</p>
