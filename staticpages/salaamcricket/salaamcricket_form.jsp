...
.trans{width:100%; position:absolute; top:0; left:0px; background:url(http://media2.intoday.in/indiatoday/images/alpha.png) repeat; z-index:99; }
.popup{ position:fixed;width:580px; height:300px; background:#f3f0e7; border:5px solid black; z-index:9999; left: 0;bottom: 0;right: 0;top: 0;margin: auto; }
...
.query{ width:330px; margin:0 auto; margin-top:35px;}
.query textarea{ width:308px; height:100px; margin-bottom:15px;}
.button a{border-radius:4px; background:#f15b26; width:95px; height:25px; line-height:25px; text-align:center; padding:10px 50px; font-size:16px; color:#FFF; }
.button span{margin-left:15px;}
.button span a{border-radius:4px; background:#c2272d; width:95px; height:25px; line-height:25px; text-align:center;padding:10px 50px;font-size:16px; color:#FFF; }
...
<div class="popup">
 <div class="close"><a href="#" id="close">x</a></div>
	...
	<form class="query">
        ...
        <textarea rows="10" cols="15" value="Take The Pledge"></textarea>
        <p></p>
		<div class="button"><a href="#">Publish</a><span><a href="#">Cancel</a></span></div>
...
<div class="con bottom-shadow bg-white cf">
 <div class="wrapper salam-cricket-header cf">
   <div class="logo"><a href="http://indiatoday.intoday.in/salaamcricket/index.jsp"><img src="http://media2.intoday.in/microsites/salaam_cricket/Salaam-cricket-Logo.png" border="0"></a></div>
   <div class="nav-area">
   ...
   <div class="menu">
     <ul>
         <li><a href="/salaamcricket/index.jsp" id="home">Home</a></li>
   ...
   <div style="clear:both">&nbsp;</div>
    ...
    <div class="cf">&nbsp;</div>
    <div class="hindi"><a href="http://indiatoday.intoday.in/salaamcricket/hindi/about_us.jsp" >Hindi</a></div>
 </div>
</div>
