...
<li><a href="/gallerylist/india-today-woman-summit/1/100.html">PHOTOS</a></li>
<li><a style="cursor:pointer">WOMAN SUMMIT ARCHIVE</a>
<ul style="width:232px; margin-top:32px;">
        ...
        <td>
            <div id="sponsorspage">
            	<div id="leftsponsors">
                	<ul class="mainul">
                    	<li class="mainli">
                            ...
                            <ul class="innerul">
                            	<li class="redli" id="id_1" frameheight="2800"><a href="/womansummit/delhi/2015/pcj.html" target="sponser" onClick="javascript:changeColor('id_1')">PC Jeweller Limited</a></li>
                            </ul>
                        </li>
                        <li class="mainli">
                        	<div class="mainlitop">Associate Sponsor</div>
                            <ul class="innerul">
                            	<li class="innerli" id='id_3' frameheight="1200"><a href="/womansummit/delhi/2015/necc.html" target="sponser" onClick="javascript:changeColor('id_3')" >NECC</a></li>
                            </ul>
                        </li> 
                        <li class="mainli">
                        	<div class="mainlitop">Knowledge partner</div>
                            <ul class="innerul">
                            	<li class="innerli" id='id_2' frameheight="850"><a href="/womansummit/delhi/2015/banasthali.html" target="sponser" onClick="javascript:changeColor('id_2')" >Banasthali Vidyapith</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="mainli">
                        	<div class="mainlitop">Bespoke Partner</div>
                            <ul class="innerul">
                            	<li class="innerli" id='id_7' frameheight="600"><a href="/womansummit/delhi/2015/damilano.html" target="sponser" onClick="javascript:changeColor('id_7')" >Da Milano</a></li>
                        ...
                        <li class="mainli">
                        	<div class="mainlitop">Partner</div>
                            <ul class="innerul">
                            	<li class="innerli" id='id_13' frameheight="600"><a href="/womansummit/delhi/2015/aroma-magic.html" target="sponser" onClick="javascript:changeColor('id_13')" >Aroma Magic</a></li>
                ...
                <div id="sponsorsdetails">
                	<iframe id="sponser" style="height: 1260px;" name="sponser" src="/womansummit/delhi/2015/pcj.html" width="450" marginheight="0" marginwidth="0" scrolling="No" frameborder="0"></iframe>
                </div>
                <div class="clear"></div>
            </div>
        </td>
