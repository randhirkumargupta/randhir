...
document.getElementsByTagName('script')[0], '//c2.taboola.com/nr/indiatoday-indiatoday/newsroom.js');
		...
		<style>
			...
			#leftrightads .leftad { left: -168px; top:0; }
			#leftrightads .rightad { left: 1005px; top:0; }
			.fixed { position: fixed!Important; top: 10px !Important; }
			.fix { position: fixed!Important; top: 160px !Important; }
...
<style>
	...
	.q-header{ background:#fffde8 url('http://media2.intoday.in/indiatoday/education/quiz/CATEGORY-BAND.png')no-repeat; width:675px; height:142px; position:relative;}
		...
		<div class="left-quiz-section">
	    	<form name="nationalQuizForm" action="quiz-result.jsp" method="post" id="nationalQuizFormId">
				...
				<div class="quiz-button">
					<input type="image" src="http://media2.intoday.in/indiatoday/education/quiz/submit.png" border="0" onclick="tourismResult(nationalQuizForm);"/>
				</div>
			</form>    
	    </div>
