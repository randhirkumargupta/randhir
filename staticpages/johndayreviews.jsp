<!DOCTYPE html><html lang="en">
    <head>
    <meta charset="utf-8">
<title>John Day review, Bollywood, Entertainment</title>
...
.mov-left-cont {width:650px; float:left}
...
<div class="mov-top-head"><span class="white">John Day</span></div>
<div class="mov-strap"><!-- <em>By Rohit Khilnani</em> September 9, 2013 | Update 13:52 IST --></div>


<div style="width:350px; float:left; margin-top:15px;"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/stories/2013september/john-day_350_091313074857.jpg" border="0">
<div class="clear"></div>
<div style="margin-top:10px; float:left; width:100%;">
<div style="float:left; font:bold 14px arial;color:#fff; width:60px; padding:0 10px 20px 10px;">Cast</div><div style="font:normal 14px/20px arial;color:#999999;">Naseeruddin Shah, Randeep Hooda, Shernaz Patel, Elena Kazan</div>
</div>
<div style="margin-top:10px; float:left; width:100%;">
<div style="float:left; font:bold 14px arial;color:#fff; width:60px; padding:0 10px 20px 10px;">Director</div><div style="font:normal 14px/20px arial;color:#999999;">Ahishor Solomon</div>
</div>
</div>
...
<div class="can-name">Suhani Singh<br><span class="mov-star"></span><span class="mov-star-half"></span><div class="clear"></div></div>
<div class="can-name">Saurabh Dwivedi<br><span class="mov-star"></span><div class="clear"></div></div>
</div>

<div style="width:50px; float:right; margin-right:28px; margin-top:130px;" class="rating">1<span class="startop" style="margin-left:8px;">star</span></div>
...
<div class="mov-cont">
	<div class="movie-head">Best left alone</div>
    <span class="mov-byline">By Rohit Khilnani, Headlines Today</span> <span class="mov-date">September 13, 2013</span><span class="mov-star"></span>
    <div class="clear"></div>
    <div class="kicker">Going by the looks of it we thought John Day will be a serious thriller but I will have to burst the bubble, it just pretends to be one. <span class="readmore"><a href="http://indiatoday.intoday.in/story/movie-review-john-day/1/309564.html">Read More</a></span></div>
</div>


<div class="mov-cont">
	<div class="movie-head">Ends up irritating the viewers</div>
    <span class="mov-byline">By Suhani Singh, India Today</span> <span class="mov-date">September 13, 2013</span><span class="mov-star"></span></span><span class="mov-star-half"></span>
    <div class="clear"></div>
    <div class="kicker">Ahishor Solomon's debut is supposed to be a mystery, a thriller. But with its convoluted plot and array of supporting characters, more than intriguing it ends up irritating the viewers who try to make sense of the events. <span class="readmore"><a href="http://indiatoday.intoday.in/story/movie-review-john-day/1/309694.html">Read More</a></span></div>
</div>


<div class="mov-cont">
	<div class="movie-head">A bland thriller</div>
    <span class="mov-byline">Saurabh Dwivedi, Aaj Tak</span> <span class="mov-date">September 13, 2013</span><span class="mov-star"></span>
    <div class="clear"></div>
    <div class="kicker">Incomplete, boring and confusing comes easily to the mind when describing the film. All in all, a bland thriller. <span class="readmore"><a href="http://indiatoday.intoday.in/story/movie-review-john-day/1/309545.html">Read More</a></span></div>
</div>
...
<div class="clear"></div>
<script type="text/javascript">
ajaxinclude("/commentbox1/comment_box.jsp?sId=&website=indiatoday&content_type=johndayreviews&ScfUrl=johndayreviews.jsp&StoryTitle=johndayreviews&message=&sectionInfo=");
</script>
