<!DOCTYPE html><html lang="en">
  <head>
    <meta charset="utf-8">
<title>Celebrating Janmashtami, the Dahi Handi way</title>

<META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW">

<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="description" content="Across India, Janmashtami is celebrated in various manners. Dahi Handi is perhaps the most popular of them all. So much son that it is difficult to ascertain whether it is being celebrated or competed at." />
 <meta name="keywords" content="janmashtami, janmashtami celebrations, dahi handi, india, krishna birth, birth of krishna, lord krishna" />
<link href="css/homepage.css" type="text/css" rel="stylesheet">
<link href="/staticpages/main/css/article.css" type="text/css" rel="stylesheet">
<meta property="og:title" content="Celebrating Janmashtami, the Dahi Handi way">
<meta property="og:image" content="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/food-bill/dahi-handi-1.jpg">
<meta property="og:url" content="/food-bill/">
<meta property="og:description" content="Across India, Janmashtami is celebrated in various manners. Dahi Handi is perhaps the most popular of them all. So much son that it is difficult to ascertain whether it is being celebrated or competed at.">
<link rel="image_src" href="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/food-bill/dahi-handi-1.jpg" />
<script src="http://businesstoday.intoday.in/js/jquery-1.7.2.min.js" type="text/javascript"></script>


<style>

.story_slide {width:1000px; height:750px; overflow:hidden; margin-bottom:20px;  }

            .story_slide ul { padding:0px; margin:0px; float:left; position:relative  } 

            .story_slide ul li { padding:0px; margin:0px; list-style:none; height:450px; float:left; width:1000px;  }
            ...
            .story_slide .left { position:absolute; background:url(http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/friends/Back-button.png) 5px 38px no-repeat; color:#fff; padding:10px; left:0px; top:225px; cursor:pointer; z-index:1; width:124px; height:74px  }

            .story_slide .right { position:absolute; background:url(http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/friends/Forward-button.png) 122px 38px no-repeat; color:#fff; padding:10px; right:0px; top:225px; cursor:pointer; z-index:1;  width:165px; height:74px  }
...
.frm_outer { border: 1px solid gray;
...
<div style="font-size:30px;">Celebrating Janmashtami, the Dahi Handi way</div>
<div style="font-size:16px">Across India, Janmashtami is celebrated in various manners. Dahi Handi is perhaps the most popular of them all.<br> So much son that it is difficult to ascertain whether it is being celebrated or competed at.</div>
<br>
<section>
<div id="slides">
	<div class="frm-share rght">
        <div class="socialcont">
            <div class="socialdiv">
                <a href="javascript:void('0');" onclick='javascript:window.open("http://indiatoday.intoday.in/content_Email.jsp?email=0&title= Celebrating Janmashtami, the Dahi Handi way&URL=/food-bill/","window", "status=no,resize=no,toolbar=no,scrollbars=no,width=468,height=390"); event.returnValue=false; return false;' title="Email" target="_new" rel="nofollow"><span class="imgs email lft"></span></a>
                <a href="http://www.facebook.com/sharer/sharer.php?p[url]=/food-bill/&p[title]=Celebrating Janmashtami, the Dahi Handi way&s=100&p[summary]= These five spiritual leaders have redefined their holy status by crimes. Asaram Bapu, who faces a sexual assault charge, is the latest in the list&p[images][0]=http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/food-bill/dahi-handi-1.jpg" title="Facebook" target="_new" rel="nofollow"><span class="imgs fb lft"></span></a>
                <a href="http://twitter.com/?status= Celebrating Janmashtami, the Dahi Handi way%20/food-bill/%20via%20%40indiatoday" title="Twitter" target="_new" rel="nofollow"><span class="imgs tw lft"></span></a>
            </div>
        </div>
...
<div class="right" id="right"></div>
        ...
        <li><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/food-bill/dahi-handi-1.jpg" />
	
    </li>
	
        <li><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/food-bill/dahi-handi-2.jpg" />
	
    </li>
	
        <li><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/food-bill/dahi-handi-3.jpg" />
...
<!--<div class="mainlink"><a href="http://indiatoday.intoday.in/mms-speech/index.jsp">Also See: What Manmohan Singh's Red Fort speeches reveal, unknowingly &raquo;</a></div>
</div>-->
<div style="clear:both ; margin:10px 0;"></div>
<div align="center" style="width: 660px; text-align: left; margin: 10px 0px 10px 160px;">
<script type="text/javascript">
      ajaxinclude("../commentbox/comment_box.jsp?sId=2908201301&ScfUrl=&StoryTitle=Celebrating Janmashtami, the Dahi Handi way&message=&website=special&content_type=poll&storytemplate=site&ScfUrl=holy-men.jsp")
</script>
</div>
<div style="clear:both; margin:10px 0;"></div>
...
<style>
.sharer_div .close{  
	background: none repeat scroll -826px 0 #EEEEEE;
...
<div class="fotborder">
<footer><script type="text/javascript">ajaxinclude("/staticpages/chunk_social_strip.html")</script>
<div class="clear"></div>
<div class="footband">
<ul>
	<li><a href="/">Home</a></li>
