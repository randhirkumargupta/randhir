...
<meta property="og:title" content="6 iconic non-human, characters from Sholay">
<meta property="og:image" content="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/sholay/sholey-slide_300x350.jpg">
<meta property="og:url" content="http://indiatoday.intoday.in/sholay-slide.jsp">
<meta property="og:description" content="6 iconic non-human, characters from Sholay">

<link rel="image_src" href="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/sholay/sholey-slide_300x350.jpg" />
<style>
#surfercommt {
    float: left;
    width: 800px;
...
.frm-share {float: right;height: 30px;position: relative;width: 150px; margin-bottom:15px}
...
.backto1{position: absolute; right: 1%; top: 58px; font: bold 94px/6px Arial; color: #4f4b4c !important;}
...
.backto2 a {color: #4F4B4C !important; text-decoration:none;}
.backto2 a:hover {color: #4F4B4C !important; text-decoration:underline;}
...
<div id="slides">
	<div class="frm-share rght">
        <div class="socialcont">
            <div class="socialdiv">
                <a href="javascript:void('0');" onclick='javascript:window.open("http://indiatoday.intoday.in/content_Email.jsp?email=0&title=6 iconic non-human, characters from Sholay&URL=http://indiatoday.intoday.in/sholay-slide.jsp","window", "status=no,resize=no,toolbar=no,scrollbars=no,width=478,height=390"); event.returnValue=false; return false;' title="Email" target="_new" rel="nofollow"><span class="imgs email lft"></span></a>
                <a href="http://www.facebook.com/sharer/sharer.php?p[url]=http://indiatoday.intoday.in/sholay-slide.jsp&p[title]=6 iconic non-human, characters from Sholay&s=100&p[summary]=6 iconic non-human, characters from Sholay&p[images][0]=http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/sholay/sholey-slide_300x350.jpg" title="Facebook" target="_new" rel="nofollow"><span class="imgs fb lft"></span></a>
                <a href="http://twitter.com/?status=6 iconic non-human, characters from Sholay%20http://indiatoday.intoday.in/sholay-slide.jsp%20via%20%40indiatoday" title="Twitter" target="_new" rel="nofollow"><span class="imgs tw lft"></span></a>
            </div>
        </div>
			...
			<img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/sholay/sholey-slide1.jpg" alt="" title="" />
...
<script type="text/javascript">
      ajaxinclude("../commentbox/comment_box.jsp?sId=298911&ScfUrl=&StoryTitle=6 iconic non-human, characters from Sholay&message=&website=special&content_type=poll&storytemplate=site&ScfUrl=/sholay-slide.jsp")
</script>
</div>
<div style="clear:both; margin:10px 0;"></div>
<style>
