...
<!DOCTYPE html><html lang="en">
  <head>
    <meta charset="utf-8">
<title>5 Incredible facts about Lokmanya Tilak</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="description" content="5 Incredible facts about Lokmanya Tilak" />
<meta name="keywords" content="5 Incredible facts about Lokmanya Tilak" />
...
<meta property="og:title" content="5 Incredible facts about Lokmanya Tilak">
<meta property="og:image" content="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/tilak/lokmanya_300_350.jpg">
<meta property="og:url" content="http://indiatoday.intoday.in/lokmanya-tilak.jsp">
<meta property="og:description" content="5 Incredible facts about Lokmanya Tilak">

<link rel="image_src" href="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/tilak/lokmanya_300_350.jpg" />
<style>
#surfercommt {
    float: left;
    width: 800px;
...
.frm-share {float: right;height: 30px;position: relative;width: 150px; margin-bottom:65px}
...
#slides .next,#slides .prev {position:absolute;top:5%;width:62px;height:60px;display:block;z-index:101;opacity: 0.5;filter:alpha(opacity=50);}
...
<div id="slides">
	<div class="frm-share rght">
        <div class="socialcont">
            <div class="socialdiv">
                <a href="javascript:void('0');" onclick='javascript:window.open("http://indiatoday.intoday.in/content_Email.jsp?email=0&title=5 Incredible facts about Lokmanya Tilak&URL=http://indiatoday.intoday.in/lokmanya-tilak.jsp","window", "status=no,resize=no,toolbar=no,scrollbars=no,width=478,height=390"); event.returnValue=false; return false;' title="Email" target="_new" rel="nofollow"><span class="imgs email lft"></span></a>
                <a href="http://www.facebook.com/sharer/sharer.php?p[url]=http://indiatoday.intoday.in/lokmanya-tilak.jsp&p[title]=5 Incredible facts about Lokmanya Tilak&s=100&p[summary]=5 Incredible facts about Lokmanya Tilak&p[images][0]=http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/tilak/lokmanya_300_350.jpg" title="Facebook" target="_new" rel="nofollow"><span class="imgs fb lft"></span></a>
                <a href="http://twitter.com/?status=5 Incredible facts about Lokmanya Tilak%20http://indiatoday.intoday.in/lokmanya-tilak.jsp%20via%20%40indiatoday" title="Twitter" target="_new" rel="nofollow"><span class="imgs tw lft"></span></a>
            </div>
        </div>
			...
			<img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/specials/tilak/lokmanya-slide-1.jpg" alt="" title="" />
		


		<a href="http://indiatoday.intoday.in/lokmanya-tilak.jsp?slide=2" class='next'><img src='http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/lie_gallery/lieright.png' alt='Next'></a>

</div>
<div style="clear:both; margin:10px 0;"></div>
<div align="center" style="width: 660px; text-align: center; margin: 10px 0px 10px 160px;">
<script type="text/javascript">
      ajaxinclude("../commentbox/comment_box.jsp?sId=297243&ScfUrl=&StoryTitle=5 Incredible facts about Lokmanya Tilak&message=&website=special&content_type=poll&storytemplate=site&ScfUrl=/lokmanya-tilak.jsp")
</script>
</div>
<div style="clear:both; margin:10px 0;"></div>
<style>
