...
<div class="review-banner-huma">
    <div class="carrer-graph">Career Graph</div>
    <div class="names">HUMA Qureshi</div>
</div>
<div class="clear"></div>
...
<div id="popin_example_line_123" class="popin_example"> 
					<div id="popin_example_line_1248" class="example_canvas">Loading...</div>
				</div>
				
</div>			
 
 <script>
	var myChart = new JSChart('popin_example_line_1248', 'line', 'f61b1a3df6065e242b1350f23e3df44e,c79c24b11a5fa131e5f3af9de0a95721');
					myChart.setDataArray([[1, 28.75],[2, 24.00],[3, 8.25],[4, 29.00],[5, 0],[6, 30] ]);
					...
					myChart.setLabelX([4,'2013']);
					myChart.setLabelX([5,'2013']);
					...
					myChart.setTooltip([1,'<span style="font-weight:bold; font-size:14px;">Gangs of Wasseypur –1 </span> <br>Rs. 28.75 crore <img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/movie-review/HUMA/gangs1.jpg" width="88" height="66">']);
					myChart.setTooltip([2,'<span style="font-weight:bold; font-size:14px;">Gangs of Wasseypur –2</span> <br>Rs.  24.00 crore <img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/movie-review/HUMA/gangs2.jpg" width="88" height="66">']);
					myChart.setTooltip([3,'<span style="font-weight:bold; font-size:14px;">Luv Shuv Tey Chicken Khurana</span> <br>Rs.  8.25 crore <img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/movie-review/HUMA/luv-shuv.jpg" width="88" height="66">']);
					myChart.setTooltip([4,'<span style="font-weight:bold; font-size:14px;">Ek Thi Daayan</span> <br>Rs.  29.00 crore <img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/movie-review/HUMA/ekthi.jpg" width="88" height="66">']);					
					myChart.setTooltip([5,'<span style="font-weight:bold; font-size:14px;">Shorts</span> <br>Rs.  0 crore <img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/movie-review/HUMA/shorts.jpg" width="88" height="66">']);
					myChart.setTooltip([6,'<span style="font-weight:bold; font-size:14px;">D Day</span> <br>Rs.  30 crore <img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/images/movie-review/HUMA/d-day.jpg" width="88" height="66">']);	
