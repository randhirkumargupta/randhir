...
.review-banner-yuvraj { background:url(http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/IPLfortunes/yuvraj_for_banner.jpg) left top no-repeat; width:660px; height:100px; color:#333; font-family:Arial, Helvetica, sans-serif; font-size:19px; font-weight:bold; position:relative; float:left; margin-top:30px; margin-bottom:-10px;}
...
<div class="review-banner-yuvraj">
    <div class="carrer-graph">IPL Fortunes</div>
    <div class="names">Yuvraj Singh</div>
</div>
<div class="clear"></div>
...
<div id="popin_example_line_122" class="popin_example"> 
 ...
 <script>
	var myChart = new JSChart('example_line_1222', 'line', 'f61b1a3df6065e242b1350f23e3df44e,c79c24b11a5fa131e5f3af9de0a95721');
					myChart.setDataArray([[1, 1.0 ],[2, 1.8],[3, 1.8],[4, 2.2]]);
					...
					myChart.setTooltip([1,'<span style="font-weight:bold; font-size:14px;">2008</span> $ 1.0 million']);
					myChart.setTooltip([2,'<span style="font-weight:bold; font-size:14px;">2011</span> <br>$ 1.8 million']);
					myChart.setTooltip([3,'<span style="font-weight:bold; font-size:14px;">2013</span> <br>$ 1.8 million']);
					myChart.setTooltip([4,'<span style="font-weight:bold; font-size:14px;">2014</span> <br>$ 2.2 million']);
