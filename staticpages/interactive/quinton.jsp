...
<div class="review-banner-quinton">
    <div class="carrer-graph">IPL Fortunes</div>
    <div class="names">Quinton De Kock</div>
</div>
<div class="clear"></div>
...
<div id="popin_example_line_122" class="popin_example"> 
 ...
 <script>
	var myChart = new JSChart('example_line_1222', 'line', 'f61b1a3df6065e242b1350f23e3df44e,c79c24b11a5fa131e5f3af9de0a95721');
					myChart.setDataArray([[1, 0.02 ],[2, 0.56]]);
					...
					myChart.setTooltip([1,'<span style="font-weight:bold; font-size:14px;">2013</span> $ 0.02 million']);
					myChart.setTooltip([2,'<span style="font-weight:bold; font-size:14px;">2014</span> <br>$ 0.56 million']);
