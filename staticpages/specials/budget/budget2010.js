...
function onShow(pid)
{
	...
	var strURL = "http://specials.indiatoday.com/specials/bt_event/showResult.jsp?pid="+pid+"&sid=208";
	var popupHeight = 265;
	var popupWidth = 455;
	var popupTop =  (window.screen.availHeight - popupHeight)/2;
	var popupLeft = (window.screen.availWidth - popupWidth)/2;
...
var url="http://indiatoday.intoday.in/site/rate_artical.jsp?id=" +encodeURI(i)+"&id1="+encodeURI(j);
