...
images1[0] = "url(http://indiatoday.intoday.in/site/specials/fihworldcup2010/images/tab_left.gif)";
images1[1] = "url(http://indiatoday.intoday.in/site/specials/fihworldcup2010/images/tab_right.gif)";
...
function toggle3(theDiv) {
     ...
     var elem = document.getElementById(theDiv);
		 ...
		 var elem5 = document.getElementById("Layer1");
	     var elem6 = document.getElementById("Layer2");
		 
		 elem5.style.display="none";
	elem6.style.display="none";
	elem.style.display="block";
		 }
function outchangeColor(colo) {
 var col = document.getElementById(colo);
 var col1 = document.getElementById("a");
 var col2 = document.getElementById("b");
		   
	col1.style.color="#5E6C49";
	col2.style.color="#5E6C49";
...
images3[0] = "url(http://indiatoday.intoday.in/site/specials/fihworldcup2010/images/points-table_tab1.gif)";
images3[1] = "url(http://indiatoday.intoday.in/site/specials/fihworldcup2010/images/points-table_tab2.gif)";
function changeImage3(j)
{
document.getElementById('image4').style.backgroundImage = images3[j];
}

function toggle4(theDiv) {

     var elem = document.getElementById(theDiv);
	   
		 var elem5 = document.getElementById("Layer3");
	     var elem6 = document.getElementById("Layer4");
		 
		 elem5.style.display="none";
	elem6.style.display="none";
	elem.style.display="block";
		 }
function outchangeColora(colo) {
 var col = document.getElementById(colo);
 var col1 = document.getElementById("c");
 var col2 = document.getElementById("d");
...
function onShow2()
{
	...
	var strURL = "http://specials.indiatoday.com/specials/bt_event/showResult.jsp?pid=143&sid=210";
	var popupHeight = 265;
	var popupWidth = 455;
	var popupTop =  (window.screen.availHeight - popupHeight)/2;
	var popupLeft = (window.screen.availWidth - popupWidth)/2;
