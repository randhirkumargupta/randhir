	...
	currentIndx=0;
		...
		images_gallery[0]='vid1.html';
		images_gallery[1]='vid2.html';
		images_gallery[2]='vid3.html';
		images_gallery[3]='vid4.html';
		images_gallery[4]='vid5.html';
...
function onShow()
{
	...
	var strURL = "http://specials.indiatoday.com/specials/bt_event/showResult.jsp?pid=129&sid=207";
	var popupHeight = 265;
	var popupWidth = 455;
	var popupTop =  (window.screen.availHeight - popupHeight)/2;
	var popupLeft = (window.screen.availWidth - popupWidth)/2;
