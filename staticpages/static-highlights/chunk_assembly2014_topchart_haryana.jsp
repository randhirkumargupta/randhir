...
<div id="wrapper" style="width:310px; margin-top:-70px; position:relative">
	...
	<div id="pieAllianceSmallContainer_haryana" style="height: 400px; margin-bottom:-150px;"></div>
		<div style="position:relative">
          ...
          -->	
           <table width="100%" border="0" cellspacing="0" cellpadding="8" class="schedule2" id="allianceTable_haryana">
            </table>
        </div>
        
        <div>

 <script type = "text/javascript">getAllianceAssemblyDetails("haryana");
 </script>
