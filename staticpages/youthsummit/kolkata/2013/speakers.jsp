		...
		<div id="main_content_left">
			<div class="sponcer-text-wrapper" style="background-color: #fef200; margin-top: -20px; min-height: 795px;">
			 <div style="height: 30px; clear: both;"></div>
			  <div style="width: 683px; height: 206px; background-image: url('http://media2.intoday.in/indiatoday/youthsummit/2013/kolkata/speaker-01.jpg'); position: relative;">
			  ...
			  <div style="height: 30px; clear: both;"></div>
			  <div style="width: 683px; height: 205px; background-image: url('http://media2.intoday.in/indiatoday/youthsummit/2013/kolkata/speaker-02.jpg'); position: relative;">
			   ...
			   <div style="height: 30px; clear: both;"></div>
			  <div style="width: 683px; height: 205px; background-image: url('http://media2.intoday.in/indiatoday/youthsummit/2013/kolkata/speaker-03.jpg'); position: relative;">
              ...
              <div style="height: 30px; clear: both;"></div>
			  <div style="width: 683px; height: 300px; background-repeat:no-repeat; background-image: url('http://media2.intoday.in//indiatoday/youthsummit/speaker-thumb/speaker-04.jpg'); position: relative;">
				...
				<span> CRICKET PLAYER</span></div>
					...
					<div class="caption sp15" style="text-transform:uppercase"><div><a href="speakers-bios/Mahua-Moitra.jsp">Mahua Moitra</a></div><span>General Secretary, Trinamool Congress</span></div>
