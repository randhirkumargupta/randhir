...
<title>Registration Online -  India Today Youth Summit 2013</title>
...
<script type='text/javascript' src='http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/youthsummit/2013/delhi/js/validation_030613_new.js'></script>
...
<style>
.contest_pinkbg {
    background: url("http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/youthsummit/2013/delhi/top.gif") no-repeat scroll center top transparent;
    width: 1200px;
	margin:0 auto;
	background-color:#fff;
	overflow:hidden;
}
.nav ul li a.active,.nav ul li a:hover {background:#B92E70} .nav ul li:hover { background-color:#B92E70}</style>

</head>

<body>
<div class="contest_pinkbg">
    ...
    <li><a href="http://specials.indiatoday.com/survey/mindrocks/feedback.jsp" >Feedback</a></li>-->
        ...
        <br><br><br>
<div style="width:550px; margin:0 auto 112px auto; text-align:center; padding:20px; border:2px solid #B92E70">
<p>
    India Today Group Mediaplex, FC-8<br>
Sec-16A, Film City Noida - 201301<br><br>
    Call Saurav Parmar: (0120) 4807100 Extn. 3496 &amp; 3256<br>
		E-mail: <a href="MAILTO:youthsummit@intoday.com ">youthsummit@intoday.com</a>, , Mobile No - +91 7838800397</p></div>
 </div>
