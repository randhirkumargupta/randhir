...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	var destCount = 1;
		if(frm.elements['speakers_name[]'].length>0)
	destCount=frm.elements['speakers_name[]'].length;
	var destSel   = false;
for(i = 0; i < destCount; i++){
if(frm.elements['speakers_name[]'][i].checked){
destSel = true;
break;
}
}
...
if(!destSel){
alert('Select one or more Session Speakers to Ask Question');
}
return destSel;
}
    ...
    <title>India Today Youth Summit 2011 - Mind Rocks</title>

<TITLE>Ask Your Question -  India Today Youth Summit 2012</TITLE>
<meta name="description" content="Registration Online - register online to attend India Today Youth Summit 2012." />
<meta name="keywords" content="Registration Online , India Today Youth Summit 2012" />
...
<!-- The below script Makes IE understand the new html5 tags are there and applies our CSS to it -->
    <!--[if IE]>
      <script src="http://indiatoday.intoday.in/js/html5.js"></script>
    <![endif]-->
<link rel="shortcut icon" href="/youthsummit2012/images/MR_favicon1.ico" />
...
<script src="http://indiatoday.intoday.in/js/sitejs.js" type="text/javascript"></script>
    ...
    <tr><!--<td valign="top"><a target="_blank" href="http://www.indiatoday.in/youthsummit/registration/"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/youthsummit/2013/top-banner.jpg" border="0"></a>
      ...
      <TR>
        <TD >
        <div id="banner">
            <a href="http://www.indiatoday.in/youthsummit/registration/"><img width="155" height="130" border="0" align="left" title="India Today Youth Summit 2012 - Mind Rocks" alt="Youth Summit" src="http://indiatoday.intoday.in/youthsummit2012/images/logo.jpg"></a>
            <img width="600" height="110" border="0" align="absmiddle" class="topbanner" title="India Today Youth Summit 2012 - Mind Rocks" alt="Youth Summit" src="http://indiatoday.intoday.in/youthsummit2012/images/top-banner-trans-black.gif">
...
<!--			 <li  class="active" ><a href="/youthsummit/delhi/2012/moveit.jsp">Voting</a></li>
             ...
             <li style="float:right; padding:0; margin:0; ">
             	<img src="http://indiatoday.intoday.in/youthsummit2012/images/navigation_arrow.jpg" width="17" height="29" border="0" align="left" style="position: absolute; right: 184px; top: 0px;" />
        ...
        <section>
            <div id="main_content">
                <div id="main_content_left">
                	<div style=" font:bold 18px arial; color:#ffffff; padding-left:5px; height:32px; line-height:32px; background-image:url(http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/youthsummit/question.gif); background-repeat:no-repeat; background-position:top-left">Ask Your Question</div>
                    <section id="left">
                    <form name="feedback" action="save_comment.jsp" method="post" onsubmit="javascript:return ajaxFunction_new()">
                        <table width="500" border="0"  align="center" cellpadding="0" cellspacing="10" id="ask_your_quation" style="font:bold 11px arial; color:#5A5A5A;">
                         <tr>
                                <td align="center" valign="top" colspan="2" style="font:bold 14px arial; color:#FF0000;">null</td>
                        ...
                        <table border="0" align="center" >
                            ...
                            <tr>
                                ...
                                <td  align="left" valign="middle" class="td" colspan="2"><input type="hidden" name="Session" value="null" />
                                <input type="hidden" name="id" value="0" />
                                
                                </td>
                            </tr>
                            <tr>
                                <td align="right" valign="top">Ask Your Question Here:</td>
                                <td  align="left" valign="middle" class="td"><textarea name="message"></textarea></td>
                            </tr>
                            <tr>			
                                <td width="444" align="right" valign="middle">Name:</td>
                                <td width="531"  align="left" valign="middle"><input type="text" name="FNAME" /></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="middle" ><input type="text" name="Location" /></td>
                            </tr>
                            <tr>
                                <td align="right" valign="top" ><i style="color:#FF0000">*</i>&nbsp;Enter The Code Shown:</td>
                                <td  align="left" valign="middle" class="td"><input type="text" name="number" /> </td>
                            </tr>
                            <tr>
                                <td align="right" valign="top">&nbsp;</td>
                                <td  align="left" valign="middle" class="td"><img src="img.jsp" /></td>
                            </tr>
                            
                             <tr>
                                <td align="right" valign="top">&nbsp;</td>
                                <td  align="left" valign="middle" class="td" style="font:bold 12px arial; color:#FF0000;"></td>
                            </tr>
                            <tr>
                                <td align="right" valign="middle">&nbsp;</td>
                                <td align="left" valign="middle"><input name="submit" type="submit" value="Submit" class="send_button"/></td>
                            </tr>
                        </table>
                    </form>
                    </section>
...
<div class="side_chunk">
    	<img border="0" usemap="#MapSocial" alt="Banner" src="http://indiatoday.intoday.in/specials/youthsummit/chennai/images/fb.jpg">
...
<div id="PHOTOS">
    ...
    <div>	
        <div class="mediaSbox" style="margin: 1px 1px 1px 0pt; height: 135px;">  
            <div class="imgrepeat" style="background: url(http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/youthsummit/buzz-from-mr/ali-zafar_88x66.jpg) no-repeat;"><a href="http://indiatoday.intoday.in/video/ali-zafar-sings-at-mind-rocks-summit/1/216361.html"><img border="0" title="Ali Zafar sings at Mind Rocks Summit" alt="Ali Zafar sings at Mind Rocks Summit" src="http://indiatoday.intoday.in/images/multimedia-small-thumb-play-icon.png"></a></div>
    ...
    <div class="venue">
      ...
      <div class="venueaddredd">
        ...
        <div itemscope="" itemtype="http://data-vocabulary.org/Event">
          <a href="/youthsummit/delhi/2012" itemprop="http://indiatoday.intoday.in/youthsummit/delhi/2012/index.jsp">
...
<div class="side_chunk">
 ...
 <div class="side_chunk" style="margin-bottom: 10px">
  ...
  <div class="side_chunk">
        ...
        <footer>
<iframe src="http://indiatoday.intoday.in/youthsummit2012/navigation_bottom.jsp" frameborder="0" scrolling="no" width="1003" height="410"></iframe>
       	</footer>
    </div>
</body>
</html>
