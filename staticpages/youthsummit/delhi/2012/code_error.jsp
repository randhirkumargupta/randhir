...
<TITLE>India Today Youth Summit 2012: Registration</TITLE>
</HEAD>
...
<tr><td><TABLE WIDTH="100%" BORDER="0" ALIGN="CENTER" CELLPADDING="0" CELLSPACING="0">
          <TR>
            <TD BGCOLOR="#ffffff" COLSPAN="2" height="100px;" >
            <DIV CLASS="text"><span class="NormalRed" style="color:#D81921; "><strong>You have entered wrong code, please <a href="javascript:history.back();" style="color:#204FA4;text-decoration:none">Go Back</a> and enter valid code!</strong></SPAN> </DIV></TD>
          </TR>
        </TABLE> </td></tr></TABLE>
