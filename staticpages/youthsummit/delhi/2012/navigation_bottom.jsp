...
.clear{clear:both;}
.clearline{ margin-bottom: 10px; border-bottom: 1px dotted #4E4E4E; height: 10px; }
.present{margin:0 auto 20px auto; width: 1003px; border-top:1px dotted #4E4E4E; overflow: hidden; border-bottom:1px dotted #4E4E4E; }
.presenting {margin:0 auto; padding:5px auto; width:180px; float: left;}
.presentingbox {text-align:center; margin:14px 0px; border-right:1px dotted #4E4E4E;}
.presmar{color:#C90A12; font:bold 14px/18px arial; margin-bottom: 15px;}
.partnerband {margin:0 auto; padding:5px auto; width:815px; float: right;}
.partnerbox {text-align:center; float:left; padding:5px 6px 2px 6px;font:bold 11px/15px arial;}
.partnerbox2 {text-align:center; float:left; padding:0px 16px 14px 16px;height:80px; font:bold 11px/18px arial;}
.partmar5 {margin-bottom:5px;}
/*.partmar10 {margin-bottom:10px; height:30px;}*/
.partmar20 {margin-bottom:20px;}
.partnerband .presentingbox {border-right-width: 0;}
.presenting .presentingbox a{display: inline-block; margin: 20px 0;}
...
<div class="partnerband">
 ...
 <div class="presentingbox">
<div class="presmar">PARTNERS</div>
...
<div class="partnerbox">
        ...
        <img src="/specials/youthsummit/images/e-media.gif" border="0" /></a>
</div>
...
<div class="partnerbox">
        <div class="partmar10">TV</div>
      <a href="http://www.headlinestoday.in/" target="_blank"><img src="http://origin-media2.intoday.in/microsites/youthsummit2012/sponsorlogo/hlt.gif" border="0" /></a>
	<a href="http://www.arynews.tv/english/index.asp" target="_blank"><img src="http://origin-media2.intoday.in/microsites/youthsummit2012/sponsorlogo/ary.gif" border="0" /></a>
</div>
