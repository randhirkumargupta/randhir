...
function showImgL(counter, startNo, endNo) {
	...
	if(counter<endNo-1){
	pageTracker._trackPageview('http://indiatoday.intoday.in/voter-helpline/facts.jsp?page=1&imgId='+counter+'#BN');
...
function showImgR(cntr, sNo, eNo) {
	...
	$('#wrappercont').css({'opacity' : '0.5', 'background-color':'#000' });
	if(cntr<eNo-1){
	pageTracker._trackPageview('http://indiatoday.intoday.in/voter-helpline/facts.jsp?page=1&imgId='+cntr+'#BN');
...
<footer><script type="text/javascript">ajaxinclude("http://indiatoday.intoday.in/chunk_social_strip.html")</script>
<div class="clear"></div>
<div class="footband">
<ul>
