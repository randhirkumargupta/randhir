    ...
    ALIGN="CENTER">
      <TR>
        ...
        <TABLE WIDTH="1003" BORDER="0" CELLPADDING="0" CELLSPACING="0" ALIGN="CENTER">
          <TR>
            <TD WIDTH="107"><A HREF="http://www.indiatodaygroup.com/" TARGET="_new">
            <IMG SRC="/staticpages/state-of-the-states/2012/images/itg.gif" WIDTH="107" HEIGHT="63" BORDER="0"></A></TD>
            <TD BGCOLOR="#4B4B4B">
