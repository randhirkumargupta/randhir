<!DOCTYPE html><html lang="en">
  <head>
    <meta charset="utf-8">
<title>5 lines Indian girls hear all the time....and wished they ended like this</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="description" content="In the aftermath of the December 16 Delhi gangrape, the campaign against sexual violence has picked up traction like never before. Breaking prejudiced, gender-based stereotypes is probably the first step in that direction." />
<meta name="keywords" content="Indian girls, Sexual assault, Stalker, Molestation, 5 lines Indian girls hear all the time, Comments on Indian girls, Short clothes, Partying, Drinking, Smoking, Indian girls drinking, Indian girls smoking, Indian girls partying, Sexual violence, Eve teasing, Rape, Date rape" />
...
<meta property="og:image" content="http://media2.intoday.in/indiatoday/images/indiangirls/300_350.jpg">
...
<link rel="image_src" href="http://media2.intoday.in/indiatoday/images/indiangirls/300_350.jpg" />
<style>
#surfercommt {
    float: left;
    width: 800px;
...
.frm-share {float: right;height: 30px;position: relative;width: 150px; margin-bottom:10px}
...
<div class="topbg">
	...
	<script type="text/javascript">ajaxinclude("/staticpages/indiangirls/updatedtime_chunk.jsp")</script>
...
<?php if(isset($_GET['slide']) && $_GET['slide'] == 2) { ?>
    ...
    <img src="http://media2.intoday.in/indiatoday/images/indiangirls/Slide2.jpg" alt="" title="" />
    <a href="/indiangirls/index.jsp?slide=1" class='prev'>
      <img src='http://media2.intoday.in/indiatoday/images/lie_gallery/lieleft.png' alt='Prev'>
    </a>
    <a href="/indiangirls/index.jsp?slide=3" class='next'>
      <img src='http://media2.intoday.in/indiatoday/images/lie_gallery/lieright.png' alt='Next'>
    </a>

    <?php  } elseif (isset($_GET['slide']) && $_GET['slide'] == 3) { ?>

    <img src="http://media2.intoday.in/indiatoday/images/indiangirls/Slide3.jpg" alt="" title="" />
    ...
    <img src="http://media2.intoday.in/indiatoday/images/indiangirls/Slide4.jpg" alt="" title="" />
    ...
    <img src="http://media2.intoday.in/indiatoday/images/indiangirls/Slide5.jpg" alt="" title="" />
    ...
    <img src="http://media2.intoday.in/indiatoday/images/indiangirls/Slide6.jpg" alt="" title="" />
    ...
    <?php  } else { ?>
       ...
       <img src="http://media2.intoday.in/indiatoday/images/indiangirls/Slide1.jpg" alt="" title="" />
       <a href="/indiangirls/index.jsp?slide=2" class='next'><img src='http://media2.intoday.in/indiatoday/images/lie_gallery/lieright.png' alt='Next'></a>
...
<div align="center" style="width: 660px; text-align: center; margin: 10px 0px 10px 160px;">
...
<script src="http://vuukle.com/js/vuukle.js"></script>
 <div class="vukkul-comment">
  ...
  <div id="vuukle_div"></div>
          <script type="text/javascript">
               var UNIQUE_ARTICLE_ID = "static_indiangirls";
               var SECTION_TAGS =  "";
               var ARTICLE_TITLE = "indiangirls";
...
<div class="fotborder">
<footer><script type="text/javascript">ajaxinclude("/staticpages/indiangirls/chunk_social_strip.html")</script>
<div class="clear"></div>
<div class="footband">
<ul>
	<li><a href="http://indiatoday.intoday.in/">Home</a></li>
...
<script src="/staticpages/main/js/jquery.lazyload.js" type="text/javascript" charset="utf-8"></script>
