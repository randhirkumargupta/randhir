...
<div class="wrapper cf">
    <div class="section_col">
        <div class="left_col">
        	...
        	<div class="left_col_img"><img src="/staticpages/mediaintoday/indiatoday/indiatoday-apps/Mail-today-176x176.png" width="176" height="176" alt="" title="" /></div>
...
<div class="wrapper">
    <div class="tab_section">
        ...
        <div id="tab_section">
                <div id="box7" class="content"><img src="/staticpages/mediaintoday/indiatoday/indiatoday-apps/android-new.png" width="996" height="243" usemap="#Map" />
          <map name="Map">
            ...
            <div class="aphome-slider_two">
                <div class="apbelt-outer_two">
                  ...
                  <ul class="apbelt_two">
                        <li><div class="slider-box_two"><img src="/staticpages/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/mail_today/IMG_1583.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="/staticpages/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/mail_today/IMG_1584.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="/staticpages/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/mail_today/IMG_1585.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="/staticpages/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/mail_today/IMG_1586.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="/staticpages/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/mail_today/IMG_1592.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="/staticpages/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/mail_today/IMG_1593.jpg" width="150"></div></li>
                  </ul>
