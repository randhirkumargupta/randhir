...
<div class="wrapper cf">
    <div class="section_col">
        <div class="left_col">
        	...
        	<div class="left_col_img"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/Cosmo-176x176.png" width="176" height="176" alt="" title="" /></div>
...
<p>Get all the information you need to know on style, beauty, health, work, leisure, celebrities and entertainment. Download to experience!</p>

<p>Cosmopolitan is about celebrating women; it supports, encourages, entertains, amuses, inspires and uplifts-helping its readers be the very best that they can be. For a girl who thinks of herself as fun and fearless, there's simply no other magazine.</p>

<p>When we put someone on the Cosmopolitan cover, we acknowledge her right to be counted among the best in the business. Love, sex, relationships and men are at the heart of Cosmopolitan, but there’s also style and beauty, health and fitness, work and leisure, celebrity and entertainment. Perhaps most unique is the way in which Cosmopolitan blends glamorous and gutsy, intimate and open-minded.</p>
...
<div class="wrapper">
    <div class="tab_section">
        ...
        <div id="tab_section">
          ...
          <map name="Map">
            <area shape="rect" coords="28,26,194,205" href="https://play.google.com/store/apps/details?id=com.itg.cosmopolitan" target="_blank" >
            <area shape="rect" coords="223,25,390,206" href="https://itunes.apple.com/us/app/cosmopolitan-in/id733762097?ls=1&mt=8" target="_blank">
            <area shape="rect" coords="417,27,595,208" href="#">
            <area shape="rect" coords="608,28,778,209" href="http://www.windowsphone.com/en-in/store/app/cosmopolitan/86b13e6a-c18b-48fc-b770-6b06996c95b6" target="_blank">
        	...
        	<ul class="review_list">
            	<li>
                	<h3>Shelby Rose </h3>
                    <p>Love cosmopolitan Love love love cosmopolitan love it so much I need the juice</p>
                </li>
            	<li>
                	<h3>Christina Moreno </h3>
                    <p>Cosmopolitan magazine Love it very informative and trendy.</p>
                </li>
            	<li>
                	<h3>bonsetechi sangma </h3>
                    <p>Always been my fav.</p>
                </li>
            	<li>
                	<h3>rohit jha </h3>
                    <p>Very significant stuff guys!</p>
                </li>
            	<li>
                	<h3>Laura Brandon </h3>
                    <p>Cosmo Love love love it</p>
                </li>
            	<li>
                	<h3>Anupama Srivastava </h3>
                    <p>Interesting</p>
                </li>
            	<li>
                	<h3>ravikanthan vasudeva  </h3>
                    <p>Good Have a look at this for good tips</p>
                </li>
            	<li>
                	<h3>Shubhangi Gaur </h3>
                    <p>I love this magazine</p>
                </li>
            </ul>
            ...
            <div class="aphome-slider_two">
                <div class="apbelt-outer_two">
                  ...
                  <ul class="apbelt_two">
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/cosmopolitan_app/IMG_1573.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/cosmopolitan_app/IMG_1574.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/cosmopolitan_app/IMG_1575.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/cosmopolitan_app/IMG_1576.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/cosmopolitan_app/IMG_1577.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/cosmopolitan_app/IMG_1587.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/cosmopolitan_app/IMG_1588.jpg" width="150"></div></li>
                  </ul>

                </div>
              </div>
        </div>
            <div id="box6" class="content"><p>The Cosmopolitan application allows users to view information related to style and beauty, health and fitness, work and leisure, celebrities and entertainment. The app consists of magazine stories, images of top Indian actresses, models and singers.</p></div>
