...
<?php require("navigation-and-slider.html"); ?>
<!-- end include navigation-and-slider menu file -->

<!--body area start-->
<div class="container cf">
 <div class="wrapper">
<div class="strip cf"> <h2 class="h2" style="float:left; margin-top:0;">About India Today Group Applications</h2> <div class="follow"><span style="float:left; line-height:39px; margin-right:15px;">FOLLOW</span><ul class="follow_smo"><li><a href="#" class="fb"></a></li>
<li><a href="#" class="twitter"></a></li>
<li><a href="#" class="gplus"></a></li></ul></div></div>
 <div class="cf"></div>

 <div class="left-text">
<p>The India Today Group began with a single magazine, India Today, in 1975. India Today has retained its leadership position in India for the last 3 decades.</p>
<p>India Today Group is an Indian media conglomerate. It is a diverse media group with magazines, newspapers, books, radio, television, printing and the internet.</p>
<p>India Today Group Digital (ITGD) is the digital arm of the India Today Group. It is an umbrella for the contents from the entire India Today Group. ITGD repurposes content from its flagship magazine, India Today, leading news channels - Aaj Tak, Headlines Today, business magazine- Business Today, and Indian editions of the international power brands like Cosmopolitan, Harper’s Bazaar, Good Housekeeping, Travel Plus and Men’s Health. ITGD ensures that the premium content of the Group is available in several digital formats and platforms for various categories of readers across the Internet. </p>
</div>




<div class="ad">Advertisment
    <!-- Javascript tag: -->
    <!-- begin ZEDO for channel:  IT App HP Rightnav MR 1 , publisher: India Today App , Ad Dimension: Medium Rectangle - 300 x 250 -->
    <script language="JavaScript">
    var zflag_nid="821"; var zflag_cid="2322"; var zflag_sid="4"; var zflag_width="300"; var zflag_height="250"; var zflag_sz="9";
    </script>
    <script language="JavaScript" src="http://d2.zedo.com/jsc/d2/fo.js"></script>
    <!-- end ZEDO for channel:  IT App HP Rightnav MR 1 , publisher: India Today App , Ad Dimension: Medium Rectangle - 300 x 250 -->
</div>
<div class="cf"></div>
 </div>

 <div class="wrapper margtop">
 <div class="tophead">
 <h2 class="h2">Indiatoday  <strong>Mobile APP's</strong></h2>
 <div class="catdropdown">
     <span class="hedtitle">CATEGORIES</span><div class="catseclectbox">
       <select>
 ...
 <div class="aphome-slider">
        <div class="apbelt-outer">
        <ul class="apbelt">
            <li>
            <div class="slider-box">INDIA TODAY<img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/it-app.jpg" width="140">
                <div class="slider-available-on">Available on</div>
                <a href="/applications/indiatoday.jsp"  class="view-btn">VIEW</a></div>
            <div class="slider-shadow"></div>
          </li>

           <li>
            <div class="slider-box">AAJTAK<img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/Aajtak-176x176.png" width="140">
                <div class="slider-available-on">Available on</div>
                <a href="/applications/aajtak.jsp"  class="view-btn">VIEW</a></div>
            <div class="slider-shadow"></div>
          </li>
            <!--<li><div class="slider-box">HEADLINES TODAY<img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/HT-176x176.png" width="140"><div class="slider-available-on">Available on</div><a href="/applications/headlinestoday.html"  class="view-btn">VIEW</a></div><div class="slider-shadow"></div></li>-->
            <li>
            <div class="slider-box">BUSINESS TODAY<img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/BT-176x176.png" width="140">
                <div class="slider-available-on">Available on</div>
                <a href="/applications/businesstoday.jsp"  class="view-btn">VIEW</a></div>
            <div class="slider-shadow"></div>
          </li>
            <li>
            <div class="slider-box">COSMOPOLITON<img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/Cosmo-176x176.png" width="140">
                <div class="slider-available-on">Available on</div>
                <a href="/applications/cosmopoliton.jsp"  class="view-btn">VIEW</a></div>
            <div class="slider-shadow"></div>
          </li>
            <li>
            <div class="slider-box">MAIL TODAY<img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/Mail-today-176x176.png" width="140">
                <div class="slider-available-on">Available on</div>
                <a href="/applications/mailtoday.jsp"  class="view-btn">VIEW</a></div>
            <div class="slider-shadow"></div>
          </li>
            <li>
            <div class="slider-box">NEWS FLICKS<img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/Newsflick-176x176.png" width="140">
                <div class="slider-available-on">Available on</div>
                <a href="/applications/newsflicks.jsp"  class="view-btn">VIEW</a></div>
            <div class="slider-shadow"></div>
          </li>
        ...
        <div style="float:right; width:75px;">
              <div class="apprev"></div>
              <div class="apnext"></div>
        </div>
...
<div class="cf"></div>
 ...
 <!-------------------------------------------leftrightads------------------------------------------>
 <div id="leftrightads" style="top:-123px">
<div style="left:-170px;" class="leftad">


<!-- Javascript tag: -->
<!-- begin ZEDO for channel:  IT App HP SkyScraper Ex Left , publisher: India Today App , Ad Dimension: Wide Skyscraper - 160 x 600 -->
<script language="JavaScript">
var zflag_nid="821"; var zflag_cid="2315"; var zflag_sid="4"; var zflag_width="160"; var zflag_height="600"; var zflag_sz="7";
</script>
<script language="JavaScript" src="http://d2.zedo.com/jsc/d2/fo.js"></script>
<!-- end ZEDO for channel:  IT App HP SkyScraper Ex Left , publisher: India Today App , Ad Dimension: Wide Skyscraper - 160 x 600 -->
...
<!-- Javascript tag: -->
<!-- begin ZEDO for channel:  IT App HP SkyScraper Ex Right , publisher: India Today App , Ad Dimension: Wide Skyscraper - 160 x 600 -->
<script language="JavaScript">
var zflag_nid="821"; var zflag_cid="2316"; var zflag_sid="4"; var zflag_width="160"; var zflag_height="600"; var zflag_sz="7";
</script>
<script language="JavaScript" src="http://d2.zedo.com/jsc/d2/fo.js"></script>
<!-- end ZEDO for channel:  IT App HP SkyScraper Ex Right , publisher: India Today App , Ad Dimension: Wide Skyscraper - 160 x 600 -->
