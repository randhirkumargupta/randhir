...
<div class="container cf">
  <div class="wrapper cf">
    <div class="section_col">
      <div class="left_col">
        <div class="left_col_img"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/BT-176x176.png" width="176" height="176" alt="" title="" /></div>
        <div class="right_col_text">
          <h2>Business Today</h2>
          <p>Living Media india Limited <br>
            News & Magazines Living Media India Limited</p>
          <div class="cf">
...
<p>From stock updates to Business analysis, this App has it all.</p>
<p>The Business Today application allows users to view up-to-date business news and analysis, images, videos, stock updates, Business Today magazine stories and LIVE TV.</p>
  ...
  <div class="wrapper">
    <div class="tab_section">
      ...
      <div id="tab_section">
          ...
          <map name="Map">
            <area shape="rect" coords="28,26,194,205" href="https://play.google.com/store/apps/details?id=com.businesstoday" target="_blank" >
            <area shape="rect" coords="223,25,390,206" href="https://itunes.apple.com/in/app/business-today-live/id510626540?mt=8" target="_blank">
            <area shape="rect" coords="417,27,595,208" href="http://appworld.blackberry.com/webstore/content/79054/?lang=en" target="_blank">
            <area shape="rect" coords="608,28,778,209" href="http://www.windowsphone.com/en-us/store/app/businesstoday/89dbf8fc-9b05-4232-acfc-1fb34b8a509f" target="_blank">
        	...
        	<ul class="review_list">
            	<li>
                	<h3>sumit khanna</h3>
                    <p>Actual Business This really is business concern no other news besides economic</p>
                </li>
            	<li>
                	<h3>Priscilla Michael </h3>
                    <p>Nice apps...news are updated in regular basis</p>
                </li>
            	<li>
                	<h3>Bibekananda Roy chowdhury </h3>
                    <p>Business today rearch and analysis of finanancial condition are nicely explained</p>
                </li>
            	<li>
                	<h3>Shrenikyelttiwar53 yelttiwar </h3>
                    <p>Best For new entrepreneur</p>
                </li>
            	<li>
                	<h3>Satyajeet Dikshit </h3>
                    <p>One of my favo sources for business news</p>
                </li>
            	<li>
                	<h3>simran jeet </h3>
                    <p>Best </p>
          ...
          <div class="aphome-slider_two">
            <div class="apbelt-outer_two">
              ...
              <ul class="apbelt_two">
                <li>
                  <div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/business_today/IMG_1568.jpg" width="150"></div>
                </li>
                <li>
                  <div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/business_today/IMG_1570.jpg" width="150"></div>
                </li>
                <li>
                  <div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/business_today/IMG_1571.jpg" width="150"></div>
                </li>
                <li>
                  <div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/business_today/IMG_1564.jpg" width="150"></div>
                </li>
                <li>
                  <div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/business_today/IMG_1565.jpg" width="150"></div>
                </li>
                <li>
                  <div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/business_today/IMG_1566.jpg" width="150"></div>
                </li>
                <li>
                  <div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/business_today/IMG_1567.jpg" width="150"></div>
                </li>
                <li>
                  <div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/business_today/IMG_1572.jpg" width="150"></div>
                </li>
              </ul>
            </div>
          </div>
        </div>
       		  <div id="box6" class="content"><p>The Business Today application allows users to view up-to-date news articles, magazine stories, images, videos and stock updates served through the India Today Network. The app consists of business news & articles, stock updates, business analysis and videos. </p></div>
