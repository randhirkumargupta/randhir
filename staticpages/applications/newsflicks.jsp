...
<div class="wrapper cf">
    <div class="section_col">
        <div class="left_col">
        	...
        	<div class="left_col_img"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/Newsflick-176x176.png" width="176" height="176" alt="" title="" /></div>
...
<p>The finest blend of data, design and digital journalism.</p>
<p>Newsflicks is India’s first and among the world’s very few news app where stories are conceived and created only for mobile devices. We don’t retrofit magazine, newspaper or television articles for mobile. We are mobile native.</p>

<p>Newsflicks engages, informs and entertains you by creating stories that are both timely and timeless. Our stories will stay with you long after you log off your screen.</p>

<p>We cover topics ranging from politics to campus life, from cinema to economy, from office life to health, from gender to social media... This, because we don’t confuse recency with relevance. Instead, we try to make relevant, timely and timely, timeless.</p>
...
<div class="wrapper">
    <div class="tab_section">
        ...
        <div id="box7" class="content"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/android-new.png" width="996" height="243" usemap="#Map" />
          <map name="Map">
            <area shape="rect" coords="28,26,194,205" href="https://play.google.com/store/apps/details?id=com.itgd.newsflick" target="_blank" >
            <area shape="rect" coords="223,25,390,206" href="https://itunes.apple.com/us/app/newsflicks/id889114432?mt=8" target="_blank">
          </map>
        </div>
        ...
        <div id="box1" class="content">
            <div class="aphome-slider_two">
                <div class="apbelt-outer_two">
                  ...
                  <ul class="apbelt_two">
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/news_flicks/IMG_1578.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/news_flicks/IMG_1579.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/news_flicks/IMG_1580.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/news_flicks/IMG_1581.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/news_flicks/IMG_1582.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/news_flicks/IMG_1594.jpg" width="150"></div></li>
                        <li><div class="slider-box_two"><img src="http://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/indiatoday-apps/snapshots_for_website/news_flicks/IMG_1595.jpg" width="150"></div></li>
                  </ul>

                </div>
              </div>
        </div>
		<div id="box6" class="content"><p>The NewsFlicks application covers topics ranging from politics to campus life, from cinema to economy, from office life to health, from gender to social media. This is because we don’t confuse recency with relevance.</p>
