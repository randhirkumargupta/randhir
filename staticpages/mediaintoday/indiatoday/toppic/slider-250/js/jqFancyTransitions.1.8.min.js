...
if(params.links)
$('#'+el.id).append("<a target='_blank' href='"+links[el.id][0]+"' class='ft-"+el.id+"' id='ft-"+el.id+j+"' style='width:"+tstripWidth+"px; height:"+params.height+"px; float: left; position: absolute;outline:none;'></a>");else
...
this.each(function(){init(this);});};$.fn.jqFancyTransitions.defaults={width:135,height:150,strips:1,delay:5000,stripDelay:50,titleOpacity:1,titleSpeed:1000,position:'alternate',direction:'fountainAlternate',effect:'',navigation:false,links:false};})(jQuery);