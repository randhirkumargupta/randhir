...
<script type="text/javascript" src="http://media2.intoday.in/microsites/affle-player/jwplayer/ripple.js"></script> 
	...
	//	var arrPlaylist=[];
	var arrPlaylist=["http://videodeliverys3.s3.amazonaws.com/indiatoday/video/December2013/Local Self Governance Arvind Kejriwal laying out demands.mp4"];
	var autoplay="true";
	var mp4videoFlagJS = 1;
            ...
            $(document).ready(function() {
                jwplayer("videoplayer").setup({
                    ...
                    'image': 'http://media2.intoday.in/indiatoday/kejriwal/thumb2.jpg',
		        	'autostart': false,
				    'stretching': 'fill',
		 ...
		 'streamer': "rtmp://mediaclouds3.intoday.in:80/cfx/st",
				 ...
				 'file': 'mp4:indiatoday/video/December2013/Local Self Governance Arvind Kejriwal laying out demands.mp4',						
					'modes': [
		...
		},
		{
          ...
          config: {
           ...
           'file': 'http://wowcloud.intoday.in/vods3/_definst_/mp4:amazons3/videodeliverys3/indiatoday/video/December2013/Local Self Governance Arvind Kejriwal laying out demands.mp4/playlist.m3u8',
           'provider': 'video'
          }
        ...
        },
		{
          ...
          config: {
           ...
           'file': 'http://medias3d.intoday.in/indiatoday/video/December2013/Local Self Governance Arvind Kejriwal laying out demands.3gp',
           'provider': 'video'
          }
