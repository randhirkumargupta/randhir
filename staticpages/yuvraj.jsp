...
<title>Yuvraj Singh's Double-w Career</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="description" content="Yuvraj Singh's Double-w Career - how never to fail in life." />
...
if (document.cookie.indexOf("iphone_redirect=false") == -1) window.location = "http://m.indiatoday.in/yuvraj.jsp";
}
</script>
...
<div style="bottom: 10px; float: left; margin-top: 20px; right: 0; text-align: center; width: 95%;">
...
<div id="yuvraj_bg">
  <div class="animate_area">
    ...
    <div id="img1" class="fl">
        	<div class="blink" id="1"><img src="/staticpages/main/images/yuvraj/BlinkingDot_main.gif"  alt="" /></div>
    </div>

  <div id="img2" class="fl">
        	<div class="blink" id="2"><img src="/staticpages/main/images/yuvraj/BlinkingDot_main.gif"  /></div>
    </div>

   <div id="img3" class="fl">
        	<div class="blink" id="3"><img src="/staticpages/main/images/yuvraj/BlinkingDot_main.gif" alt="" /></div>
    </div>

   <div id="img4" class="fl">
        	<div class="blink" id="4"><img src="/staticpages/main/images/yuvraj/BlinkingDot_main.gif" alt="" /></div>
    </div>
  <div id="img5" class="fl">
        	<div class="blink" id="5"><img src="/staticpages/main/images/yuvraj/BlinkingDot_main.gif" alt="" /></div>
    </div>

<div id="img6" class="fl">
        	<div class="blink" id="6"><img src="/staticpages/main/images/yuvraj/BlinkingDot_main.gif" alt="" /></div>
    </div>
