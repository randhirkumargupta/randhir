...
<title>News Wiz Quiz Competition Telecast Schedule - India Today</title>
<meta name="description" content="Get all the news Wiz Quiz competition telecast schedule details. Check and know the schedule dates when the quiz episode is dated. Check Now."/>
<meta name="keywords" content="News Wiz Quiz Schedule, News Wiz Quiz Schedule, News Wiz, news quiz, Rajdeep Sardesai, Siddhartha Basu, india today quiz, News Quiz rules, News Quiz schedule, News Quiz faq"/>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="terms-condition">
                    <h3>quiz telecast schedule </h3>
                    <div class="terms-outer">
                      <div class="term-lft">
                        <div class="schedule_area">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td>Episode-1 (PRELIMS)</td>
                              <td>26-08-2017 (Sat)</td>
                            </tr>
                            <tr>
                              <td>Episode-2 (PRELIMS)</td>
                              <td>02-09-2017 (Sat)</td>
                            </tr>
                            <tr>
                              <td>Episode-3 (PRELIMS)</td>
                              <td>09-09-2017 (Sat)</td>
                            </tr>
                            <tr>
                              <td>Episode-4 (PRELIMS)</td>
                              <td>16-09-2017 (Sat)</td>
                            </tr>
                            <tr>
                              <td>Episode-5 (PRELIMS)</td>
                              <td>23-09-2017 (Sat)</td>
                            </tr>
                            <tr>
                              <td>Episode-6 (PRELIMS)</td>
                              <td>30-09-2017 (Sat)</td>
                            </tr>
                            <tr>
                              <td>Episode-7 (PRELIMS)</td>
                              <td>07-10-2017 (Sat)</td>
                            </tr>
                            <tr>
                              <td>Episode-8 (PRELIMS)</td>
                              <td>14-10-2017 (Sat)</td>
                            </tr>
                            <tr>
                              <td>Episode-9 (PRELIMS)</td>
                              <td>21-10-2017 (Sat)</td>
                            </tr>
                            <tr>
                              <td>Episode-10 (SEMI-FINAL)</td>
                              <td>28-10-2017 (Sat)</td>
                            </tr>
                            <tr>
                              <td>Episode-11 (SEMI-FINAL)</td>
                              <td>04-11-2017 (Sat)</td>
                            </tr>
                            <tr>
                              <td>Episode-12 (SEMI-FINAL)</td>
                              <td>11-11-2017 (Sat)</td>
                            </tr>
                            <tr>
