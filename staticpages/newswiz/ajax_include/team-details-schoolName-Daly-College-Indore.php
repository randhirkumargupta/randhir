...
<div class="team_sch_area">
	<div class="team_sch_logo">
		<img src="http://media2.intoday.in/indiatoday/resources/newswiz/team/school-logo/daly-college-indore.gif" alt="Daly College Indore">
		<div class="all_vote_area">
			<div class="arrow_box" id="upcount22">
			
			   214 
			
			</div>
			<strong class="upcount566622"></strong> <strong>popularity score</strong>
			
				<a href="javascript:changeRating1('5666','text','1','22', '214', '0','0')" class="vote-btn"></a>
...
<p>&nbsp;</p>
        ...
        <div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><h3 class="team_hdn"><span>Team</span></h3></div></div>  
	                        ...
	                        <div class="row box_dn">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
	                            	<div class="team_box">
	                                	<div class="team_pic"><img src="http://media2.intoday.in/indiatoday/resources/newswiz/team/vaibhav-parik.png" alt="VAIBHAV PARIK"></div>
	                                  	<div class="plyer_name">VAIBHAV PARIK</div>
	                                  	
	                                </div>
	                            </div>
	                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
	                            	<div class="team_box">
	                                	<div class="team_pic"><img src="http://media2.intoday.in/indiatoday/resources/newswiz/team/rishabh-shrimal.png" alt="RISHABH SHRIMAL"></div>
	                                  	<div class="plyer_name">RISHABH SHRIMAL</div>
        ...
        <p></p>
        	...
        	<a href="javascript:changeRating1('5666','text','1','22', '214', '0','0')" class="vote-btn suport_btn" ></a>
