	...
	<div class="team_sch_logo">
		...
		<div class="sup_like_all sup_like_all1">
            ...
            <div class="share_like">
            	<ul>
                	<li>SHARE ON</li>
                   	<li class="fb_icon"><a target="_blank" href="https://facebook.com/sharer.php?u=/newswiz/team.jsp?teamname=Choice-School-Ernakulam"><img src="/staticpages/mediaintoday/indiatoday/resources/newswiz/newimages/fb-icon-sup.png" alt=""></a></li>
                   	<li class="tw_icon"><a target="_blank" href="https://twitter.com/intent/tweet?url=/newswiz/team.jsp?teamname=Choice-School-Ernakulam&text=I support Choice School Ernakulam&via=indiatoday"><img src="/staticpages/mediaintoday/indiatoday/resources/newswiz/newimages/twi-icon-sup.png" alt=""></a></li>
                </ul>
			</div>
		</div>
