...
<section class="header_2017_newswiz">
 ...
 <li><a href="question-of-the-week.jsp" title="SHOW QUIZ" class="active_h">SHOW QUIZ</a></li>
            ...
            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="auth_newswiz_q">
                    <div class="container_wiz_q">
            		  <iframe name='proprofs' id='proprofs' width='100%' height='100%' frameborder=0 marginwidth=0 marginheight=0 src='https://www.proprofs.com/quiz-school/story.php?title=question-of-the-week&id=1968144&ew=430' style="min-height: 357px;">
</iframe>
<div style='font-size:10px; font-family:Arial, Helvetica, sans-serif; text-align:left;'><a href='https://www.proprofs.com/quiz-school/browse/' title='ProProfs Quizzes' target='_blank' rel='nofollow'>ProProfs Quizzes</a></div>
                 ...
                 <!--<div class="auth_newswiz_q">
                    <div class="container_wiz_q">
            		  <h3><span class="icon_scnd"></span><span>Prizes</span> to be won</h3>
						<img src="https://itgd-mum-dev-static.s3.amazonaws.com/media/others/mediaintoday/indiatoday/resources/newswiz/newimages/quiz/prizestowin.jpg" class="resp"/>
                    </div>
                  </div>-->

                 <div class="auth_newswiz_q">
                    <div class="container_wiz_q">
            		  <h3><span class="icon_thrd"></span><span>Contest</span> Details</h3>
						<ul class="cntsdtls_q">
							<li>This is a weekly contest. The question will change every Sunday and the contest will end on following Tuesday at 11:59 PM</li>
							<li>One winner will be selected every week</li>
							<li>The participant who provides the correct answer wins.</li>
							<li>In case there are more than one participants who have provided the correct answer, the winner will be selected randomly.</li>
							<li>The winner will be contacted on the mobile number shared with us.</li>
							<li>Prizes will be distributed after the contest ends.</li>
							<li>Visit here for detailed Terms and Conditions</li>
						</ul>	
                    </div>
                  </div>              
