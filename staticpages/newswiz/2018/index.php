...
<style>    
.video_episode_snippets .video_inner p {font-size: 15px !important;line-height: 18px;padding: 5px;}.video_info,.item {background: none !important;}.outer-video-area {margin-bottom: 56px;background-color: #fff;}.video_episode_snippets .video_inner {height: auto; margin-bottom:15px;}.video_episode_snippets .video_inner img {height: 232px;}.timeline-outer .slider-year {background: none !important;overflow: hidden}.timeline-slider ul li {background-color: #fff;} 
