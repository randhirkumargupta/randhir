...
'drupal-userpass' => array('drupalauth:External',
 ...
 'drupalroot' => '/opt/httpd/vhosts/staging-sso.indiatodayonline.in/httpdocs/',
 ...
 // Which attributes should be retrieved from the Drupal site.
           ...
           'attributes' => array(
                                 array('drupaluservar'   => 'uid',  'callit' => 'uid'),
                                  ...
                                  array('drupaluservar' => 'field_mobile_number','callit' => 'mn'),
    ...
    */
    ...
    'facebook' => array(
        ...
        'api_key' => '160976001119355',
        // App Secret
        'secret' => '17b70320575070cd8fbed8e9fd50903d',
    ...
    */
    ...
    'twitter' => array(
        'authtwitter:Twitter',
        'key' => 'gGVAXeanVFkUVNMM9o6mpEJdS',
        'secret' => 'cbwePTy7e5CX6ANFfJQ5cA6QM2V5IMDWRQxNbk0QvI0qu6rx08',
